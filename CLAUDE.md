...
This project is indexed by GitNexus as **ConferenceSpace** (21168 symbols, 39425 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
