...
This project is indexed by GitNexus as **ConferenceSpace** (5672 symbols, 14520 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
