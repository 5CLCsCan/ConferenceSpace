...
Giới thiệu tổng quan các quy trình trong hệ thống mà AI tham gia xử lý, sau đó phân nhóm theo vai trò người dùng và vị trí của workflow trong quy trình hội nghị. Với mỗi workflow, cần trình bày mô tả nghiệp vụ, sơ đồ luồng hoạt động, dạng đầu vào, dạng đầu ra và ranh giới kiểm soát của con người. Phần này cần nhấn mạnh rằng mỗi workflow tạo đầu ra hỗ trợ để người dùng kiểm tra lại, không tự động thay thế quyết định học thuật.
...
Trình bày workflow kiểm tra chất lượng bản nháp phản biện, gồm phát hiện phản biện thiếu căn cứ, thiếu chiều sâu, không nhất quán hoặc có nguy cơ không đáp ứng yêu cầu biểu mẫu. Mục này cần nhấn mạnh auditor là công cụ hỗ trợ tự kiểm tra hoặc hỗ trợ Chair, không phải bộ lọc tự động quyết định bài báo đạt hay không đạt. Cần mô tả rõ ba trạng thái `pass`, `warn`, `block`; đặc biệt, `block` chỉ áp vào thao tác gửi review khi bản review chưa đủ tư cách là một phản biện học thuật ở trạng thái hiện tại, và runtime chỉ map một số lỗi nghiêm trọng thành block ở chế độ trước khi gửi chính thức. Đồng thời, mục này phải nêu giới hạn hiện tại: AI vẫn có thể hallucinate hoặc tạo false block gây friction cho reviewer; hướng cải tiến là đưa cơ chế kiểm tra chéo bằng NLI từ benchmark hậu kiểm vào runtime, kết hợp xếp hạng/hợp nhất bằng chứng kiểu RRF để hạ mức hoặc yêu cầu xác nhận đối với finding thiếu groundedness.
