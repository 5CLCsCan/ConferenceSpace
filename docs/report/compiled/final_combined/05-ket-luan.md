...
Sau khi khảo sát nhu cầu, xác định khoảng trống, thiết kế hệ thống và đánh giá thực nghiệm, chương này tổng kết mức độ hoàn thành của đề tài ConferenceSpace so với mục tiêu ban đầu. Mục đích của phần kết luận không phải là liệt kê lại toàn bộ chức năng đã xây dựng, mà là rút ra những kết quả có thể bảo vệ được từ chuỗi bằng chứng đã trình bày ở các chương trước.

Luận điểm xuyên suốt của đề tài là: AI có thể được tích hợp vào quy trình xét duyệt bài báo nếu hệ thống giữ rõ ranh giới giữa nghiệp vụ cốt lõi, cơ chế xác định và các workflow hỗ trợ bằng AI. Trong ranh giới đó, AI không thay thế tác giả, người phản biện hoặc Chair; AI chỉ hỗ trợ nhập liệu, kiểm tra sớm, định hướng đọc, kiểm toán bản nháp và tổng hợp bằng chứng để con người ra quyết định tốt hơn.

## 5.1. Kết quả đạt được

### 5.1.1. Nền tảng nghiệp vụ và kiến trúc hệ thống

Đề tài đã xây dựng được một nền tảng hỗ trợ quy trình xét duyệt bài báo theo nhiều vai trò, bao gồm tác giả, người phản biện, Chair và quản trị viên. Hệ thống bao phủ các vòng đời nghiệp vụ chính trong phạm vi đề tài: cấu hình hội nghị, nộp bài, khai báo và kiểm tra xung đột lợi ích, gợi ý hoặc phân công phản biện, thu thập phản biện, rebuttal, thảo luận, hỗ trợ Chair tổng hợp bằng chứng và theo dõi trạng thái hội nghị.

Các use case ở Chương 3 cho thấy hệ thống không chỉ tập trung vào một màn hình hoặc một chức năng đơn lẻ, mà được tổ chức theo dòng công việc của từng vai trò. Với tác giả, hệ thống hướng tới giảm thao tác nhập liệu và phát hiện lỗi trước khi gửi chính thức. Với người phản biện, hệ thống hỗ trợ quá trình đọc bài, viết phản biện và tự kiểm tra chất lượng bản nháp. Với Chair, hệ thống hỗ trợ theo dõi tiến độ, kiểm soát rủi ro, xem xét xung đột lợi ích, điều phối phản biện và tổng hợp bằng chứng trước khi ra quyết định.
...
Kết quả benchmark lớp nghiệp vụ ở Chương 4 cho thấy hệ thống backend đạt 0% lỗi request trong các kịch bản CRUD, Matching và COI ở quy mô thử nghiệm gồm 300 hội nghị, 15.000 bài nộp và 9.000 người phản biện. Độ trễ p95 của các nhóm kịch bản đều dưới 120 ms trong điều kiện benchmark hiện tại. Kết quả này cho phép kết luận rằng lớp nghiệp vụ cốt lõi vận hành ổn định trong phạm vi kiểm thử của đề tài, đồng thời chỉ ra điểm cần chú ý khi mở rộng là tải lên PostgreSQL khi dữ liệu quan hệ tăng.
...
Trong benchmark reviewer matching, hệ thống được đánh giá trên tập dữ liệu Semantic Scholar gồm 60 tác giả và 2.565 bài báo. Kết quả ranking đạt MRR 0,392, Hit@5 đạt 55% và Hit@10 đạt 65%, cao hơn baseline ngẫu nhiên. Ở bài toán assignment, hệ thống không ghi nhận vi phạm COI trong benchmark và đạt mức phù hợp trung bình tốt hơn baseline. Tuy nhiên, coverage 65,9% và fallback rate 23,3% cũng cho thấy thuật toán chưa thể thay Chair xử lý mọi trường hợp phân công khó.
...
Các workflow AI trong ConferenceSpace được triển khai theo nguyên tắc hỗ trợ từng điểm nghẽn cụ thể của quy trình, không tự động hóa toàn bộ quá trình xét duyệt. Mỗi workflow có đầu vào, đầu ra, ranh giới kiểm soát và tiêu chí đánh giá riêng. Điều này giúp báo cáo tránh cách đánh giá chung chung như "AI tốt hay không tốt", thay vào đó xem xét AI theo đúng nhiệm vụ mà nó được giao.

Submission Autofill là workflow có bằng chứng định lượng mạnh nhất ở nhóm hỗ trợ tác giả. Trên tập benchmark ở Chương 4, hệ thống đạt title exact 91,22%, title token F1 98,20%, abstract ROUGE-1 83,64%, abstract ROUGE-L 83,25%, keyword F1 92,77%, author F1 83,49% và required field completion 86,93%. Các kết quả này cho thấy AI có giá trị rõ ở tác vụ tạo bản nháp metadata cho form nộp bài. Phần gợi ý track nằm bên trong Submission Autofill cũng hoàn tất 48/48 trường hợp và có invalid track rate 0,00%, nhưng do chưa có nhãn chuyên gia nên chỉ có thể kết luận hệ thống giữ gợi ý trong danh sách track hợp lệ, không kết luận về độ chính xác chuyên môn của track được đề xuất.

Submission Gating cho thấy giá trị ở việc đưa lỗi về sớm trước khi bài được gửi chính thức. Tuyến rule xác định đạt 8/8 completion, blocking verdict accuracy 100%, rule ID recall 100% và không ghi nhận false block trong tập benchmark rule. Tuyến đánh giá nội dung mềm hoàn tất 24/24 trường hợp và không tự động tạo block ngoài hợp đồng đã định nghĩa. Vì vậy, kết luận phù hợp là workflow này có thể hỗ trợ kiểm tra hình thức, policy và cảnh báo nội dung cần xem lại; nó không thay Chair đưa ra quyết định desk rejection học thuật.
...
Review Quality Auditor là workflow có giá trị tiềm năng nhưng cũng bộc lộ rủi ro rõ nhất. Trên 3.658 lượt audit, hệ thống sinh trung bình 2,39 finding mỗi audit, nhưng truthfulness 58,28%, validity 71,04% và grounded-valid 46,99% cho thấy finding còn nhiễu. Vì vậy, auditor nên được dùng như công cụ hỗ trợ tự kiểm tra hoặc hỗ trợ Chair phát hiện review nghèo thông tin, thiếu căn cứ hoặc tự mâu thuẫn; không nên xem nó là bộ lọc tự động quyết định chất lượng học thuật của bài báo hoặc của người phản biện.

Chair Decision Copilot đạt evidence basis truthfulness 87,34%, disagreement map truthfulness 87,11%, evidence additionality 91,63% và high-risk rate 1,28%. Kết quả này cho phép kết luận workflow có ích trong việc tổng hợp review, rebuttal, điểm đồng thuận, điểm bất đồng và rủi ro cần Chair xem lại. Tuy nhiên, benchmark không đo decision label match, nên không có cơ sở kết luận Copilot dự đoán đúng quyết định accept hoặc reject. Vai trò đúng của Copilot là giúp Chair đọc và đối chiếu bằng chứng nhanh hơn, không sinh quyết định thay Chair.

Chatbot Agent hoàn tất 40/40 hội thoại benchmark, gồm 25 trường hợp pass, 12 trường hợp partial và 3 trường hợp fail. Tỷ lệ tool-call success đạt 75,78%, với 97 lời gọi thành công trên 128 lời gọi. Kết quả này cho thấy hướng tiếp cận agent có thể hỗ trợ người dùng truy vấn trạng thái, thao tác và dữ liệu trong phạm vi quyền truy cập, nhưng độ ổn định công cụ và độ trễ phản hồi vẫn cần cải thiện trước khi xem đây là một trợ lý sản phẩm ổn định.

### 5.1.4. Mức độ đáp ứng mục tiêu đề tài

Đối chiếu với mục tiêu ở Chương 1, đề tài đã đạt được bốn kết quả chính.

Thứ nhất, nhóm đã xây dựng được một nền tảng nghiệp vụ có khả năng hỗ trợ quy trình xét duyệt bài báo trong hội nghị khoa học, thay vì chỉ dừng ở mô hình hoặc prototype giao diện. Các chức năng được đặt trong dòng công việc nhiều vai trò và có cơ chế trạng thái, phân quyền, dữ liệu và triển khai tương ứng.
...
Thứ tư, nhóm đã xây dựng được một chuỗi đánh giá nhiều lớp thay vì chỉ đánh giá cảm tính. Chương 4 tách riêng benchmark backend, benchmark thuật toán xác định, benchmark workflow AI, phân tích vận hành và khảo sát người dùng sau sử dụng. Cách đánh giá này giúp kết luận của đề tài có ranh giới rõ: phần nào đã có bằng chứng định lượng, phần nào mới có bằng chứng proxy, phần nào chỉ nên xem là phản hồi định tính ban đầu.
...
Giới hạn lớn nhất của nhóm workflow AI là output vẫn có thể hallucinate, diễn giải quá mạnh hoặc tạo finding chưa đủ căn cứ. Điều này đặc biệt quan trọng ở các workflow gần điểm quyết định như Review Quality Auditor và Chair Decision Copilot. Nếu hệ thống trình bày output AI như kết luận tuyệt đối, người dùng có thể hiểu sai vai trò của AI và làm lệch trách nhiệm học thuật.
...
Một số workflow AI có độ trễ cao và có outlier vượt 100 giây. Điều này không phù hợp với mọi tương tác đồng bộ trên giao diện. Các workflow như Reviewer Initial Analysis, Review Quality Auditor và Chair Decision Copilot cần được vận hành theo hướng chạy nền, có queue, retry, timeout theo stage, trạng thái tiến độ và cơ chế đánh dấu artifact cũ khi dữ liệu nguồn thay đổi.

Chatbot Agent còn tỷ lệ tool-call failure đáng kể. Dù benchmark không ghi nhận rò rỉ dữ liệu trong kịch bản kiểm tra quyền truy cập, độ tin cậy của lời gọi công cụ, cách báo lỗi và thời gian phản hồi vẫn cần cải thiện. Với một agent có quyền truy vấn dữ liệu hệ thống, yêu cầu quan trọng không chỉ là trả lời đúng, mà còn là từ chối đúng khi người dùng không có quyền hoặc khi dữ liệu không đủ.

Về sản phẩm, một số workflow nghiệp vụ vẫn cần hoàn thiện nếu hệ thống hướng tới vận hành thật. Discussion cần được kiểm soát chặt hơn theo visibility, loại thread, trạng thái submission và vai trò người dùng. Camera-ready hiện mới được hỗ trợ ở mức upload sau khi bài được chấp nhận, chưa có đầy đủ workflow Chair phê duyệt, yêu cầu nộp lại, deadline runtime và lịch sử phiên bản. Bidding cũng là một cơ chế có giá trị thực tế cho phân công phản biện nhưng chưa nằm trong phạm vi triển khai hiện tại.

Cuối cùng, hệ thống còn phụ thuộc vào provider/model bên ngoài cho các thao tác LLM, bao gồm `gemini-3.1-flash-lite` thông qua OpenRouter hoặc model router tương thích OpenAI client. Sự phụ thuộc này tạo rủi ro về chi phí, giới hạn dịch vụ, độ ổn định, thay đổi chất lượng mô hình và yêu cầu bảo mật dữ liệu bản thảo. Vì vậy, chi phí và khả năng mở rộng nên tiếp tục được đánh giá bằng token, độ trễ và chính sách vận hành, thay vì gắn kết luận vào một bảng giá cố định.

## 5.3. Hướng phát triển trong tương lai

### 5.3.1. Nâng độ tin cậy và khả năng kiểm tra của output AI

Hướng phát triển ưu tiên là đưa một phần cơ chế hậu kiểm từ benchmark vào runtime. Thay vì chỉ chạy TCA/NLI sau khi benchmark, hệ thống có thể chuẩn hóa finding, attention point hoặc rationale thành các claim rõ ràng, ghép chúng với evidence từ bài nộp, review, rebuttal và artifact liên quan, sau đó đánh giá groundedness trước khi giữ mức cảnh báo cao.

Với Review Quality Auditor, các finding thiếu groundedness nên được hạ từ block xuống warn hoặc yêu cầu reviewer/Chair xác nhận trước khi chặn gửi chính thức. Cách làm này giữ được vai trò bảo vệ của auditor đối với các review quá nghèo thông tin hoặc tự mâu thuẫn, đồng thời giảm rủi ro false block gây friction cho người phản biện.

Giao diện cũng cần hiển thị rõ bằng chứng đi kèm output AI: đoạn trích nguồn, trường dữ liệu liên quan, mức độ nghiêm trọng, lý do cảnh báo và trạng thái kiểm tra. Người dùng phải có khả năng chỉnh sửa, bỏ qua, xác nhận hoặc phản hồi chất lượng output. Những phản hồi này có thể trở thành dữ liệu vận hành để cải thiện workflow và benchmark về sau.

### 5.3.2. Hoàn thiện vận hành và trải nghiệm sử dụng

Các workflow AI dài cần được chuyển sang cơ chế vận hành bất đồng bộ rõ ràng hơn. Hệ thống nên có hàng đợi xử lý, retry có giới hạn, timeout theo từng stage, tiến độ xử lý, thông báo khi hoàn tất và trạng thái artifact không còn hiện hành khi dữ liệu nguồn thay đổi. Đây là điều kiện cần để biến các workflow đã có kết quả benchmark thành trải nghiệm sử dụng ổn định.

Chatbot Agent cần được cải thiện theo hướng agent có kiểm soát, không chỉ là giao diện hội thoại. Các tool cần có schema rõ hơn, thông báo lỗi dễ hiểu hơn, test quyền truy cập chặt hơn và observability tốt hơn để truy vết vì sao một câu trả lời bị fail hoặc partial. Giao diện nên phân biệt các trạng thái "đang truy vấn dữ liệu", "đang tổng hợp", "không đủ quyền" và "không có dữ liệu phù hợp".
...
Reviewer matching cũng nên được đánh giá bằng dữ liệu gần vận hành hơn. Các hướng khả thi gồm thu thập historical assignment, Chair-labeled assignment, tỷ lệ Chair chấp nhận đề xuất, chất lượng review sau phân công và tác động đến thời gian hoàn tất vòng phản biện. Nếu bổ sung bidding, hệ thống có thể kết hợp bid của reviewer với điểm phù hợp chuyên môn, tải công việc và COI để tạo cơ chế phân công sát thực tế hơn.

Về nghiệp vụ, các phần cần hoàn thiện tiếp gồm visibility và quyền trong Discussion, workflow camera-ready, bidding, lịch sử phiên bản, deadline runtime và các thao tác Chair sau quyết định. Những phần này giúp hệ thống tiến gần hơn đến vận hành hội nghị thật, thay vì chỉ chứng minh các vòng đời cốt lõi ở mức thử nghiệm.

### 5.3.4. Tăng tính tự chủ khi triển khai thực tế

Một hướng phát triển dài hạn là giảm phụ thuộc vận hành vào provider bên ngoài. Nhóm có thể đánh giá phương án dùng mô hình open-weight hoặc triển khai on-premise cho những hội nghị có yêu cầu bảo mật cao. Hướng này cần được cân nhắc cùng chi phí hạ tầng, độ trễ, chất lượng đầu ra, khả năng cập nhật mô hình và công sức vận hành.
...
Tóm lại, ConferenceSpace chứng minh rằng AI có thể tạo giá trị trong quy trình xét duyệt bài báo khi được đặt đúng vai trò: hỗ trợ thao tác, hỗ trợ đọc hiểu, kiểm tra bản nháp và tổng hợp evidence. Giá trị đó chỉ bền vững khi hệ thống giữ quyền quyết định học thuật cho con người, cung cấp bằng chứng để kiểm tra lại và thừa nhận rõ những giới hạn của dữ liệu, mô hình và môi trường vận hành. Kết luận của đề tài vì vậy không phải là AI có thể thay thế con người trong peer review, mà là một nền tảng được thiết kế đúng ranh giới có thể dùng AI để giảm tải một số điểm nghẽn mà vẫn bảo vệ trách nhiệm học thuật của tác giả, người phản biện và Chair.
