...
\label{Chapter4DemoAppendix}

\par\noindent\rule{\textwidth}{0.4pt}\par

\section{Mục tiêu và phạm vi đánh giá}

Chương 3 đã phân chia ConferenceSpace thành ba lớp trách nhiệm: nghiệp vụ cốt lõi, thuật toán xác định có thể kiểm chứng và AI hỗ trợ. Chương này đánh giá mức độ hoàn thành trách nhiệm của từng lớp trong các điều kiện thử nghiệm đã xác định, sau đó đối chiếu kết quả kỹ thuật với phản hồi của người dùng. Do mỗi lớp tạo ra một loại đầu ra khác nhau, nghiên cứu sử dụng các nguồn bằng chứng riêng thay vì quy toàn bộ hệ thống về một thước đo chung.

Bảng~\ref{tab:ch4-demo-questions} trình bày bốn câu hỏi đánh giá, nguồn bằng chứng và phạm vi kết luận tương ứng. Các nhãn ``bằng chứng trực tiếp'', ``chỉ số gián tiếp'' và ``chưa đo'' mô tả mức độ mà phép đo hỗ trợ nhận định; chúng không phải thang xếp hạng chất lượng sản phẩm.

\begin{longtable}{|>{\RaggedRight\arraybackslash}p{0.27\textwidth}|>{\RaggedRight\arraybackslash}p{0.27\textwidth}|>{\RaggedRight\arraybackslash}p{0.22\textwidth}|>{\RaggedRight\arraybackslash}p{0.18\textwidth}|}
  \caption{Câu hỏi đánh giá và phạm vi bằng chứng}\label{tab:ch4-demo-questions}\\[0.5\baselineskip]
  \hline
  Câu hỏi đánh giá & Nguồn bằng chứng & Chỉ số chính & Phạm vi kết luận \\ \hline
  \endfirsthead
  \hline
  Câu hỏi đánh giá & Nguồn bằng chứng & Chỉ số chính & Phạm vi kết luận \\ \hline
  \endhead
  ...
  Các luồng AI có tạo đầu ra đủ bám bằng chứng và giữ đúng ranh giới hỗ trợ hay không? & Đối chiếu trực tiếp, phép chấm TCA và thử nghiệm hội thoại & Exact Match, ROUGE, F1, Truthfulness, Coverage, Additionality và kết quả hội thoại & Từng tác vụ và từng bộ kiểm thử tương ứng \\ \hline
  Kết quả kỹ thuật có tương ứng với trải nghiệm của người dùng hay không? & Khảo sát sau sử dụng theo ba vai trò & Mức hài lòng, cảm nhận giảm thao tác và phản hồi định tính & Cảm nhận của mẫu người dùng tham gia \\ \hline
\end{longtable}
...
Chương 4 giữ phần thông tin cần thiết để người đọc hiểu mục tiêu, đối tượng, đầu vào, kịch bản, thao tác, giá trị của phép đo và giới hạn diễn giải. Phụ lục C không thay thế phần trình bày này; phụ lục cung cấp mức chi tiết sâu hơn về điều kiện khởi tạo, fixture, snapshot, đơn vị đo, định dạng tư liệu và các khoảng trống truy vết. Vì vậy, người đọc có thể đọc Chương 4 để nắm mạch đánh giá, sau đó sử dụng các mục~\ref{appc:index}--\ref{appc:operations} để kiểm tra hoặc tái lập từng nhóm phép đo.

\subsection{Kịch bản đánh giá và đầu vào theo nhóm}

Mỗi nhóm đánh giá trả lời một câu hỏi riêng. Nhóm hiệu năng backend kiểm tra hành vi của ba đường xử lý HTTP trên dữ liệu tổng hợp gồm 300 hội nghị, 15.000 bài nộp và 9.000 quan hệ phản biện viên--hội nghị. Nhóm thuật toán dùng hai loại đầu vào: bộ kiểm thử Go ở nhiều quy mô để tách chi phí xử lý, và snapshot tổng hợp gồm 60 hồ sơ tác giả cùng 2.565 bài báo để đánh giá hành vi xếp hạng và phân công. Nhóm AI xử lý 1.127 bài từ tập ReviewRebuttal đã chọn lọc; các phép kiểm tra riêng gồm 48 trường hợp gợi ý chuyên đề, 8 trường hợp kiểm tra luật, 24 trường hợp cảnh báo nội dung và 40 hội thoại Chatbot Agent. Phụ lục~\ref{appc:algorithm-contract} và Phụ lục~\ref{appc:direct-fixtures} trình bày các điều kiện đầu vào ở mức kỹ thuật.

Ba kịch bản backend gồm truy vấn đọc, gợi ý phản biện viên và kiểm tra xung đột lợi ích. Kịch bản truy vấn đọc lần lượt liệt kê hội nghị, liệt kê bài nộp và tìm kiếm người dùng; mặc dù được gọi là CRUD trong tư liệu tải, kịch bản chỉ thực hiện yêu cầu đọc. Kịch bản gợi ý phản biện viên gọi đường xử lý \CodeBreak{reviewer-suggestions} nhưng không tự động phân công. Kịch bản xung đột lợi ích gọi đường xử lý kiểm tra xung đột, trong đó có truy vấn quan hệ đồng tác giả trên Neo4j.

Đối với xếp hạng, nhóm giữ lại một bài từ mỗi hồ sơ tác giả làm truy vấn, loại bài đó khỏi hồ sơ tương ứng rồi xếp hạng các hồ sơ còn lại bằng Jaccard, \CodeBreak{overlap\_count} và phương pháp ngẫu nhiên. Đối với phân công, nhóm so sánh Greedy với gán tuần tự và ngẫu nhiên bằng độ phủ, độ đồng đều, điểm Jaccard, lượt dự phòng và số ca tự gán. Vì chưa có phương án phân công tối ưu do Chủ tọa xác nhận, nhãn tác giả gốc và các chỉ số nội tại chỉ là bằng chứng gián tiếp.

Đối với các luồng AI, bộ thực thi tạo và lưu đầu ra trước; bộ chấm TCA đọc lại các gói đã lưu mà không tạo lại nội dung. Submission Autofill được đối chiếu với siêu dữ liệu tham chiếu; Submission Gating được tách thành nhánh kiểm tra luật và nhánh cảnh báo không chặn; Reviewer Initial Analysis, Review Quality Auditor và Chair Decision Copilot được đánh giá theo quan hệ mệnh đề--bằng chứng; Chatbot Agent được chạy theo tám nhóm kịch bản với ba vai trò. Hình~\ref{fig:ch4-ai-evaluation-flow} minh họa sự tách biệt giữa tạo đầu ra, đối chiếu trực tiếp, TCA và chấm theo hành vi hội thoại.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    block/.style={draw, rounded corners, align=center, minimum height=0.8cm, text width=2.5cm, fill=gray!8},
    arrow/.style={-{Latex[length=2mm]}, thick}
  ]
    \node[block] (data) {Bài nộp và\\ ngữ cảnh nguồn};
    \node[block, right=of data] (worker) {Bộ thực thi\\ luồng xử lý};
    \node[block, right=of worker] (outputs) {Gói đầu ra\\ và điểm kiểm tra};
    \node[block, below=of outputs] (direct) {Đối chiếu trực tiếp\\ Autofill / Gating};
    \node[block, left=of direct] (tca) {TCA\ cho đầu ra văn bản};
    \node[block, left=of tca] (chat) {Chấm theo kịch bản\\ Chatbot Agent};
...
Đầu ra kỳ vọng của mỗi nhóm gồm trạng thái hoàn tất, tư liệu có thể truy xuất và các đại lượng tương ứng với câu hỏi đánh giá. Backend cần ghi nhận thông lượng, độ trễ và tỷ lệ lỗi; microbenchmark cần ghi nhận thời gian và bộ nhớ cấp phát; đánh giá xếp hạng và phân công cần tạo chỉ số trên cùng đầu vào; các luồng AI cần lưu đầu ra, thời gian, token và kết quả chấm; Chatbot Agent cần lưu hội thoại, nhật ký gọi công cụ và nhãn hồi cứu. Những điều kiện này xác định giá trị của từng phép đo và ngăn việc dùng một loại bằng chứng để kết luận về một trách nhiệm khác.
...
Các nhóm thực nghiệm còn lại sử dụng tập kiểm thử phù hợp với từng trách nhiệm. Kiểm thử backend dùng dữ liệu tổng hợp gồm 300 hội nghị, 15.000 bài nộp và 9.000 quan hệ phản biện viên--hội nghị. Đánh giá đối sánh dùng 60 hồ sơ tác giả và 2.565 bài báo tổng hợp. Submission Autofill có thêm 48 trường hợp kiểm thử gợi ý chuyên đề; Submission Gating có 8 trường hợp kiểm thử luật và 24 trường hợp kiểm thử cảnh báo nội dung; Chatbot Agent có 40 hội thoại thuộc tám nhóm kịch bản. Phụ lục~\ref{AppendixC} trình bày phân bố dữ liệu, điều kiện chạy và quy trình chấm chi tiết.
...
\begin{longtable}{|>{\RaggedRight\arraybackslash}p{0.20\textwidth}|>{\RaggedRight\arraybackslash}p{0.31\textwidth}|>{\RaggedRight\arraybackslash}p{0.20\textwidth}|>{\RaggedRight\arraybackslash}p{0.21\textwidth}|}
  \caption{Môi trường và tư liệu thực nghiệm}\label{tab:ch4-demo-environments}\\[0.5\baselineskip]
  \hline
  Nhóm thực nghiệm & Môi trường hoặc phương pháp & Quy mô chính & Tư liệu đầu ra \\ \hline
  \endfirsthead
  \hline
  Nhóm thực nghiệm & Môi trường hoặc phương pháp & Quy mô chính & Tư liệu đầu ra \\ \hline
  \endhead
...
\subsection{Phương pháp và ranh giới diễn giải}

Kiểm thử tải dùng k6 để tạo tải HTTP lên API. Go microbenchmark chạy trực tiếp trên mã thuật toán nhằm tách thời gian xử lý và mức sử dụng bộ nhớ khỏi chi phí HTTP, cơ sở dữ liệu và mạng. Phép thử xếp hạng dùng phương pháp leave-one-out theo tác giả; phép thử phân công so sánh Greedy với gán tuần tự và ngẫu nhiên bằng các chỉ số nội tại vì chưa có phương án phân công tối ưu do Chủ tọa xác nhận.

Các đầu ra AI được đánh giá theo ba cách. Submission Autofill được đối chiếu với siêu dữ liệu tham chiếu bằng Exact Match, ROUGE và F1; phần kiểm tra luật của Submission Gating được đối chiếu với phán quyết và mã luật dự kiến. Reviewer Initial Analysis, Review Quality Auditor và Chair Decision Copilot được đánh giá bằng khung TCA gồm Truthfulness, Coverage và Additionality. Chatbot Agent được kiểm tra qua các kịch bản hội thoại theo vai trò, quyền truy cập và phạm vi hỗ trợ.

TCA là phép chấm tự động mang tính thăm dò. Truthfulness ước lượng tỷ lệ mệnh đề có bằng chứng hỗ trợ; Coverage đo mức trùng khớp với nội dung tham chiếu do con người tạo; Additionality đo tỷ lệ mệnh đề có căn cứ nhưng không trùng trực tiếp với tham chiếu. Phương pháp này chưa được hiệu chuẩn bằng nhãn chuyên gia, nên các chỉ số chỉ mô tả quan hệ giữa mệnh đề và bằng chứng, không trực tiếp đo tính hữu ích học thuật.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth]{fig02_k6_throughput.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\textwidth]{fig03_k6_latency_percentiles.png}
...
Hệ thống tính độ tương đồng Jaccard theo công thức $J(A,B)=|A\cap B|/|A\cup B|$, sau đó áp dụng thủ tục gán tham lam có xét giới hạn tải. Go microbenchmark đo trực tiếp mã thuật toán và không bao gồm HTTP, cơ sở dữ liệu hoặc mạng. Hình~\ref{fig:ch4-microbench-scale} trình bày thời gian xử lý theo quy mô đầu vào, còn Hình~\ref{fig:ch4-microbench-allocs} trình bày số lần cấp phát bộ nhớ. Hai hình thay thế cho bảng số liệu chi tiết để làm nổi bật xu hướng tăng chi phí khi quy mô đầu vào mở rộng.
...
\begin{longtable}{|>{\RaggedRight\arraybackslash}p{0.22\textwidth}|>{\centering\arraybackslash}p{0.13\textwidth}|>{\centering\arraybackslash}p{0.13\textwidth}|>{\centering\arraybackslash}p{0.13\textwidth}|>{\centering\arraybackslash}p{0.13\textwidth}|>{\centering\arraybackslash}p{0.14\textwidth}|}
...
Cơ chế phát hiện xung đột lợi ích gồm kiểm tra tự gán, quan hệ do người dùng khai báo và quan hệ đồng tác giả từ một đến ba bậc trên Neo4j trong khoảng thời gian cấu hình. Microbenchmark chỉ bao phủ hai bộ kiểm tra xác định đầu tiên. Nghiên cứu chưa đo thời gian hoặc chất lượng phát hiện của lớp đồ thị, chưa có tập cặp xung đột do chuyên gia gán nhãn và chưa kiểm tra đầu cuối khi Neo4j không khả dụng. Vì vậy, kết quả hiện tại chưa xác nhận chất lượng của toàn bộ cơ chế đa tầng.

\section{Đánh giá các luồng AI hỗ trợ}

\subsection{Submission Autofill và Submission Gating}

Trên 1.127 bài, Submission Autofill đạt F1 theo token của tiêu đề 98,20\%, F1 từ khóa 92,77\% và F1 tác giả 83,49\%. Tỷ lệ hoàn tất trường bắt buộc đạt 86,93\%. Các trường ngắn và có cấu trúc rõ đạt mức khớp cao hơn trường có cấu trúc phức tạp. Hình~\ref{fig:ch4-autofill-quality} minh họa sự khác biệt giữa các nhóm trường. Giá trị thấp nhất bằng 0 ở một số trường cho thấy luồng có những trường hợp thất bại hoàn toàn; hệ thống vì vậy chỉ nên tạo bản nháp để Tác giả kiểm tra và chỉnh sửa.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\textwidth]{fig08_autofill_quality.png}
...
Trên 1.127 bài, Review Quality Auditor tạo 3.658 lượt kiểm tra, gồm 1.913 lượt mang trạng thái \textit{block}, 1.650 lượt \textit{warn} và 95 lượt \textit{pass}. Trong luồng hiện hành, \textit{severity=blocking} biểu thị mức nghiêm trọng của phát hiện, còn \textit{status=block} làm nổi bật bản phản biện cần được xem xét trên giao diện. Cả hai nhãn chỉ phục vụ hiển thị và hỗ trợ Phản biện viên chỉnh sửa; chúng không ngăn thao tác nộp bản phản biện. Vì vậy, các số liệu này phản ánh mức độ ưu tiên của phát hiện, không phải số lần hệ thống từ chối thao tác.
...
Các kết quả chỉ xác nhận mức bám nguồn của bản tổng hợp theo phép chấm TCA. Nghiên cứu chưa đo mức độ đầy đủ và hữu ích theo đánh giá của Chủ tọa, thời gian đọc, độ chính xác quyết định hoặc thiên lệch tự động hóa. Chủ tọa vì vậy vẫn phải kiểm tra nguồn và chịu trách nhiệm về quyết định cuối cùng.

\subsection{Chatbot Agent}

Chatbot Agent được đánh giá như một trợ lý truy vấn dữ liệu ConferenceSpace theo quyền của người dùng, không phải trợ lý nghiên cứu hoặc hệ thống trò chuyện tự do. Bộ thử gồm tám nhóm kịch bản, mỗi nhóm có năm biến thể diễn đạt. Trợ lý hoàn tất luồng phản hồi trong cả 40 hội thoại; báo cáo rà soát thủ công hồi cứu phân loại 25 lượt đạt, 12 lượt đạt một phần và 3 lượt không đạt. Tỷ lệ gọi công cụ thành công đạt 97/128 lượt, tương ứng 75,78\%. Hình~\ref{fig:ch4-chatbot-outcomes} và Hình~\ref{fig:ch4-chatbot-tools} tách kết quả hội thoại khỏi khả năng gọi công cụ; tỷ lệ gọi công cụ không được diễn giải như tỷ lệ hoàn tất hội thoại.
...
Các kết quả dẫn đến ba yêu cầu vận hành: chuyển tác vụ dài sang hàng đợi nền; hiển thị tiến độ, lỗi và khả năng thử lại; giảm 31 lượt gọi công cụ thất bại của Chatbot Agent. Nghiên cứu chưa kiểm tra đầu cuối khi yêu cầu đến dịch vụ AI hết thời gian chờ hoặc khi dịch vụ ngừng hoạt động.
...
\begin{longtable}{|>{\RaggedRight\arraybackslash}p{0.27\textwidth}|>{\RaggedRight\arraybackslash}p{0.43\textwidth}|>{\RaggedRight\arraybackslash}p{0.22\textwidth}|}
  \caption{Mức kết luận theo trách nhiệm và bằng chứng}\label{tab:ch4-demo-synthesis}\\[0.5\baselineskip]
  \hline
  Nội dung đánh giá & Bằng chứng chính & Mức kết luận \\ \hline
  \endfirsthead
  \hline
  Nội dung đánh giá & Bằng chứng chính & Mức kết luận \\ \hline
  \endhead
