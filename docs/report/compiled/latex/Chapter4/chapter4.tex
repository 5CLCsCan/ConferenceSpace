...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[>=Latex,
    ...
    \node[process] (claim) at (0,0) {Mệnh đề đầu ra};
    \node[process] (sourceCheck) at (0,-2.3) {Đối chiếu với nguồn dữ liệu};
    \node[decision] (sourceSupported) at (0,-5.0) {Nguồn dữ liệu có hỗ trợ?};
    \node[outcome, fill=red!7] (skipGrounding) at (5.4,-5.0) {Không vượt bước bám nguồn};
    \node[process, fill=green!7] (groundedClaim) at (0,-7.8) {Mệnh đề bám nguồn};
    \node[decision] (hasReference) at (0,-10.6) {Có văn bản tham chiếu phù hợp?};
    \node[outcome, fill=orange!9] (groundingOnly) at (5.8,-10.6) {Chỉ báo cáo mức bám nguồn};
    \node[process] (referenceCheck) at (0,-13.5) {Đối chiếu với văn bản tham chiếu};
    \node[outcome, fill=green!7] (referenceRecorded) at (-4.7,-16.2) {Được văn bản tham chiếu ghi nhận};
    \node[outcome, fill=red!7] (referenceNotRecorded) at (4.7,-16.2) {Không được văn bản tham chiếu ghi nhận};
    ...
    \draw[flowArrow] (referenceCheck.south) -- ++(-2.7,-0.9) -- (referenceRecorded.north);
    \draw[flowArrow] (referenceCheck.south) -- ++(2.7,-0.9) -- (referenceNotRecorded.north);
  \end{tikzpicture}
  \end{adjustbox}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{fig02_k6_throughput.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{fig03_k6_latency_percentiles.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{fig02_ranking_hit_at_k.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{fig06_assignment_coverage_score.png}
...
Không ghi nhận rò rỉ dữ liệu trong các kịch bản quyền đã kiểm tra. Tuy nhiên, một biến thể ngoài phạm vi vẫn tạo nội dung không phù hợp, còn tư liệu chấm chưa ghi đầy đủ người chấm và ngày chấm; vì vậy, phân bố 25/12/3 chỉ được xem là bằng chứng mô tả.
