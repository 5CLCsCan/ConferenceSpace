...
Bộ thực thi lưu đầu ra trước khi bắt đầu hoạt động chấm.
...
\begin{figure}[H]
  ...
  \caption{Token trung bình theo đơn vị công việc của các luồng công việc AI}
  \label{fig:ch4-resource-tokens}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.80\textwidth]{fig11_resource_latency.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.80\textwidth]{fig13_resource_ops_mode.png}
