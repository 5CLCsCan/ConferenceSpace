...
Mỗi nhóm đánh giá trả lời một câu hỏi riêng. Nhóm hiệu năng backend kiểm tra hành vi của ba đường xử lý HTTP trên dữ liệu tổng hợp gồm 300 hội nghị, 15.000 bài nộp và 9.000 quan hệ phản biện viên--hội nghị; cấu hình khởi tạo được trình bày tại Mục~\ref{appc:backend-contract}. Nhóm thuật toán dùng hai loại đầu vào: bộ kiểm thử Go ở nhiều quy mô để tách chi phí xử lý, và snapshot tổng hợp gồm 60 hồ sơ tác giả cùng 2.565 bài báo để đánh giá hành vi xếp hạng và phân công (Mục~\ref{appc:algorithm-contract}). Nhóm AI xử lý 1.127 bài từ tập ReviewRebuttal (Re2) đã chọn lọc~\cite{ch4ref1}; các phép kiểm tra riêng gồm 48 trường hợp gợi ý chuyên đề, 8 trường hợp kiểm tra luật và 24 trường hợp cảnh báo nội dung được mô tả tại Mục~\ref{appc:direct-fixtures}, còn 40 hội thoại Chatbot Agent được mô tả tại Mục~\ref{appc:chatbot}.
...
\begin{longtable}{|>{\raggedright\arraybackslash}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.40\textwidth}|>{\raggedright\arraybackslash}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.21\textwidth}|}
...
Các đầu ra AI được đánh giá theo ba cách. Submission Autofill được đối chiếu với siêu dữ liệu tham chiếu bằng Exact Match, F1 và ROUGE, trong đó ROUGE đo mức trùng lặp giữa văn bản tạo ra và văn bản tham chiếu~\cite{ch4ref9}; phần kiểm tra luật của Submission Gating được đối chiếu với phán quyết và mã luật dự kiến. Reviewer Initial Analysis, Review Quality Auditor và Chair Decision Copilot được đánh giá bằng khung TCA gồm Truthfulness, Coverage và Additionality. Chatbot Agent được kiểm tra qua các kịch bản hội thoại theo vai trò, quyền truy cập và phạm vi hỗ trợ.
