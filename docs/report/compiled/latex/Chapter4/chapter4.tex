...
Chương 3 đã trình bày ConferenceSpace theo ba lớp trách nhiệm: nghiệp vụ cốt lõi, thuật toán xác định có thể kiểm chứng và AI hỗ trợ. Chương này đánh giá mức độ hoàn thành trách nhiệm của từng lớp trong điều kiện thử nghiệm, đồng thời đối chiếu kết quả kỹ thuật với phản hồi của người dùng. Do mỗi lớp tạo ra một loại đầu ra khác nhau, chương sử dụng các nguồn bằng chứng riêng thay vì quy toàn bộ hệ thống về một thước đo chung.
...
\begin{longtable}{|P{0.28\textwidth}|P{0.28\textwidth}|P{0.22\textwidth}|P{0.16\textwidth}|}
  ...
  \endfoot
  Hệ thống nghiệp vụ có đủ nhanh và ổn định trong điều kiện tải thử nghiệm hay không? & k6, thống kê lỗi yêu cầu và giám sát tài nguyên & Thông lượng, độ trễ p95, tỷ lệ yêu cầu thất bại, mức sử dụng CPU và mức sử dụng RAM & Mục 4.3 \\ \hline
  Thuật toán đối sánh và phát hiện xung đột lợi ích có chạy nhanh, cho kết quả có thể tái lập và có thể giải thích hay không? & Go microbenchmark và thử nghiệm trên dữ liệu tổng hợp mô phỏng lược đồ Semantic Scholar & Thời gian xử lý, bộ nhớ, Hit@k, MRR, nDCG, độ phủ và độ đồng đều của khối lượng phân công & Mục 4.4 \\ \hline
...
Đối với lớp AI, nhóm chọn một tập con của ReviewRebuttal (Re2), bộ dữ liệu chứa hồ sơ phản biện bài báo qua nhiều giai đoạn từ OpenReview~\cite{ch4ref1}. Tập dữ liệu thực nghiệm gồm các bản ghi có đủ thành phần đầu vào cần thiết để thực hiện lại ít nhất một luồng được đánh giá, chẳng hạn bài nộp, siêu dữ liệu, nhận xét phản biện, phản hồi của tác giả hoặc bản tổng hợp nhận xét. Các phép chấm Coverage có thể dùng phản hồi hoặc bản tổng hợp nhận xét làm tham chiếu. Phạm vi này giới hạn kết quả ở bài báo tiếng Anh và bối cảnh hội nghị có cấu trúc dữ liệu tương tự OpenReview.

Quy trình thực nghiệm xử lý 1.127 bài từ tám hội nghị hoặc chuyên đề. Các báo cáo kết quả TCA sử dụng 1.097 gói, chênh lệch 30 gói so với tập dữ liệu thực nghiệm. Hai mẫu số phục vụ hai mục tiêu khác nhau: 1.127 bài được dùng để đo khả năng tạo đầu ra và hành vi vận hành, còn 1.097 gói được dùng để đánh giá quan hệ giữa đầu ra văn bản và bằng chứng nguồn. Tuy nhiên, tư liệu hiện có chưa kèm bảng kê hợp nhất về 30 gói không được đưa vào TCA, lý do loại và phân bố theo luồng; vì vậy, nghiên cứu chưa loại trừ được thiên lệch chọn mẫu do chênh lệch này. Bảng sau cho thấy tập dữ liệu thực nghiệm không tập trung vào một nguồn duy nhất, nhưng bốn nguồn lớn nhất chiếm 70,72\% số bài.
...
Đối với một số chức năng có bản chất đánh giá khác, nghiên cứu sử dụng các tập kiểm thử riêng: 48 trường hợp kiểm thử gợi ý chuyên đề, 8 trường hợp kiểm thử luật và 24 trường hợp kiểm thử cảnh báo nội dung của Submission Gating, cùng 40 hội thoại thuộc tám nhóm kịch bản của Chatbot Agent.

Kiểm thử backend sử dụng tập dữ liệu tổng hợp gồm 300 hội nghị, 15.000 bài nộp và 9.000 quan hệ phản biện viên--hội nghị. Đánh giá đối sánh dùng tập dữ liệu tổng hợp mô phỏng lược đồ Semantic Scholar gồm 60 hồ sơ tác giả và 2.565 bài báo. Các tập dữ liệu tổng hợp này cung cấp đầu vào cho phép tái lập thử nghiệm, nhưng không đại diện cho phân công hoặc quan hệ xung đột lợi ích trong một hội nghị thực tế.

\subsection{Môi trường và phương pháp đánh giá}

Bảng~\ref{tab:ch4-environments} tóm tắt môi trường, quy mô và tư liệu của từng nhóm thực nghiệm. Tư liệu của từng tác vụ cho phép truy vết từ chỉ số tổng hợp đến ngữ cảnh nguồn, đầu ra của luồng xử lý và kết quả chấm tương ứng; quy trình và đường dẫn đến tư liệu phục vụ tái lập thử nghiệm được lưu cùng bộ benchmark. Phần kết quả chỉ diễn giải các đại lượng được tạo ra từ những môi trường này.
...
\begin{longtable}{|P{0.25\textwidth}|P{0.31\textwidth}|P{0.19\textwidth}|P{0.19\textwidth}|}
  ...
  TCA & \CodeBreak{dleemiller/ModernCE-large-nli} phân loại quan hệ bằng chứng--mệnh đề; Qwen3.5-2B và Qwen3.5-0.8B thực hiện chuẩn hóa và phân loại mức độ hỗ trợ~\cite{ch4ref2,ch4ref3} & 1.097 gói kết quả & JSONL theo bài và nhóm chỉ số \\ \hline
...
Nghiên cứu sử dụng ba cách chấm cho các loại đầu ra AI. Submission Autofill được đối chiếu với siêu dữ liệu tham chiếu bằng Exact Match, ROUGE và F1; phần kiểm tra luật của Submission Gating được đối chiếu với phán quyết và mã luật dự kiến. Chatbot Agent được chấm theo khả năng hoàn tất yêu cầu, bám dữ liệu nền tảng, tuân thủ quyền truy cập và kiểm soát phạm vi.

Khung TCA (Truthfulness--Coverage--Additionality) đánh giá Reviewer Initial Analysis, Review Quality Auditor và Chair Decision Copilot. Truthfulness ước lượng tỷ lệ mệnh đề có bằng chứng hỗ trợ. Coverage và Additionality chỉ được tính trên các mệnh đề đã qua bước Truthfulness; các mệnh đề hành chính được tách khỏi tỷ lệ kỹ thuật. Coverage đo mức trùng khớp với nội dung tham chiếu do con người tạo, còn Additionality đo tỷ lệ mệnh đề có căn cứ nhưng không trùng trực tiếp với tham chiếu. TCA là phương pháp chấm tự động mang tính thăm dò, chưa được hiệu chuẩn bằng nhãn chuyên gia; các chỉ số này mô tả quan hệ giữa mệnh đề và bằng chứng, không trực tiếp đo tính hữu ích học thuật.

Các kịch bản backend kiểm tra ba nhóm yêu cầu: truy vấn đọc dữ liệu gồm liệt kê hội nghị, bài nộp và tìm kiếm người dùng; yêu cầu gợi ý phản biện viên; và yêu cầu kiểm tra xung đột lợi ích có truy vấn quan hệ đồng tác giả trên Neo4j. Microbenchmark tách chi phí mã thuật toán khỏi độ trễ đầu cuối.

Trong phép thử xếp hạng, nhóm giữ lại đúng một bài từ mỗi hồ sơ trong tập 60 hồ sơ tác giả để làm truy vấn; hệ thống loại bài này khỏi hồ sơ, xếp hạng lại toàn bộ 60 hồ sơ và dùng vị trí của tác giả gốc làm nhãn thay thế. Nghiên cứu so sánh Jaccard, số chủ đề chung và phương pháp ngẫu nhiên trên cùng tập truy vấn. Điều kiện này đo khả năng truy hồi quan hệ chủ đề đã biết, không tạo nhãn tham chiếu về phản biện viên phù hợp. Đối với phân công, Greedy được so sánh với gán tuần tự và ngẫu nhiên bằng các chỉ số nội tại vì chưa có phương án phân công tối ưu do Chủ tọa xác nhận.

Các luồng AI được đánh giá theo hai bước: quy trình chạy thử tạo và lưu đầu ra; bộ chấm đọc lại các gói kết quả để đánh giá mức bám bằng chứng mà không tạo lại nội dung. Cách tách này giúp phân biệt khả năng vận hành với chất lượng đầu ra. Yêu cầu về dữ liệu đầu vào cũng được kiểm tra theo từng luồng. Reviewer Initial Analysis chỉ nhận siêu dữ liệu bài nộp và nội dung bản thảo; Review Quality Auditor nhận bản phản biện, chính sách và có thể nhận kết quả phân tích ban đầu; Chair Decision Copilot nhận bài nộp, các bản phản biện, thảo luận và phản hồi của tác giả, trong khi bản tổng hợp nhận xét tham chiếu chỉ được dùng ở bước chấm.

Riêng Chatbot Agent sử dụng một hội nghị giả lập với các tài khoản Tác giả, Phản biện viên và Chủ tọa. Tám nhóm kịch bản bao phủ tra cứu dữ liệu của chính người dùng, thông tin công khai, tổng quan hội nghị, khối lượng phản biện, yêu cầu vượt quá quyền truy cập của người dùng, yêu cầu ngoài phạm vi và báo cáo vận hành nhiều bước.

Khảo sát sau sử dụng thu thập mức hài lòng, cảm nhận về mức độ dễ thao tác và ý kiến mở. Báo cáo tổng hợp khảo sát ghi 91 phản hồi hợp lệ, gồm 76 phản hồi của Tác giả, 7 phản hồi của Phản biện viên và 8 phản hồi của Chủ tọa.

Tệp dữ liệu thô đang lưu chỉ có sáu bản ghi Chủ tọa, trong đó năm bản ghi thiếu phần đánh giá chính, nên không thể tái lập độc lập các thống kê $n=8$ từ tệp này. Tư liệu hiện có cũng chưa ghi nhận đầy đủ quy trình tuyển mẫu, nhiệm vụ được chuẩn hóa và thời lượng trải nghiệm. Vì vậy, chương giữ số liệu Chủ tọa theo báo cáo tổng hợp nhưng xem đây là bằng chứng mô tả chưa đầy đủ về nguồn gốc và khả năng truy vết; mỗi tỷ lệ được trình bày theo mẫu số của câu hỏi tương ứng.
...
Cả ba kịch bản đều ghi nhận tỷ lệ yêu cầu thất bại bằng 0\%. Bảng~\ref{tab:ch4-http-load-results} trình bày kết quả tải HTTP trong cấu hình đã nêu.
...
\begin{longtable}{|P{0.16\textwidth}|C{0.12\textwidth}|C{0.14\textwidth}|C{0.12\textwidth}|C{0.12\textwidth}|C{0.12\textwidth}|C{0.12\textwidth}|}
  ...
  \hline
  \TableHeader{Kịch bản} & \TableHeader{Số yêu cầu} & \TableHeader{Thông lượng} & \TableHeader{Độ trễ trung vị} & \TableHeader{p90} & \TableHeader{p95} & \TableHeader{Độ trễ tối đa} \\ \hline
  \endfirsthead
  \LongTableHeaderBorder
  \TableHeader{Kịch bản} & \TableHeader{Số yêu cầu} & \TableHeader{Thông lượng} & \TableHeader{Độ trễ trung vị} & \TableHeader{p90} & \TableHeader{p95} & \TableHeader{Độ trễ tối đa} \\ \hline
  \endhead
...
Trong phạm vi thử nghiệm, backend xử lý hàng trăm yêu cầu mỗi giây trên tập 15.000 bài nộp và giữ độ trễ p95 dưới 120 ms. Hai endpoint đối sánh và xung đột lợi ích có độ trễ trung vị 9,5--9,7 ms, thấp hơn kịch bản CRUD. Kết quả chỉ phản ánh các đường xử lý đã chọn trong tải ngắn hạn; phép thử không thay thế kiểm thử đầy đủ các luồng chức năng từ đầu đến cuối hoặc kiểm thử chạy bền.

\subsection{Tài nguyên tiêu thụ}

Container API sử dụng trung bình 28\% công suất của một nhân CPU, cao nhất 43\%, và khoảng 30 MB RAM. PostgreSQL tiêu thụ CPU cao nhất, trung bình khoảng 115\% công suất của một nhân và đạt mức cao nhất 163\%, với mức RAM 204--222 MB. Neo4j dùng khoảng 508 MB RAM nhưng dưới 1\% CPU, còn Redis dùng khoảng 9 MB RAM. Vì phép đo chưa tách thời gian truy vấn, kết quả chỉ cho thấy PostgreSQL là thành phần cần ưu tiên kiểm tra khi tối ưu, không chứng minh đây là điểm nghẽn duy nhất ở cấu hình khác.
...
Jaccard đạt MRR 0,392, cao gấp khoảng năm lần phương pháp ngẫu nhiên. Tuy nhiên, \CodeBreak{overlap\_count} đạt Hit@10 và nDCG@10 cao hơn Jaccard; chênh lệch giữa hai phương pháp được so sánh chưa cho thấy một phương pháp chiếm ưu thế ổn định trên 60 truy vấn.

Nhãn tác giả gốc chỉ kiểm tra khả năng truy hồi quan hệ chủ đề đã mã hóa trong dữ liệu. Phép thử không đo mức phù hợp của phản biện viên; trong vận hành thật, tác giả của bài còn là một xung đột lợi ích hiển nhiên. Thuật toán đồng thời trả về điểm Jaccard và các lĩnh vực trùng khớp cho từng cặp, nên giao diện có thể trình bày các tín hiệu này như căn cứ để người dùng kiểm tra đề xuất. Đây là đặc tính thiết kế; mức độ Chủ tọa hiểu hoặc sử dụng các căn cứ đó nằm ngoài phạm vi thử nghiệm hiện tại.

\subsection{Hành vi của thuật toán phân công}

Vì Chủ tọa chưa xác nhận phương án phân công tối ưu, thử nghiệm so sánh các chỉ số nội tại của Greedy với gán tuần tự và ngẫu nhiên. Độ phủ là tỷ lệ bài có ít nhất hai phản biện viên; tỷ lệ dùng lượt dự phòng là tỷ lệ bài cần lượt gán thứ hai, trong đó thuật toán bỏ ngưỡng điểm và giới hạn tải nhưng vẫn giữ xung đột lợi ích là ràng buộc cứng.
...
\begin{longtable}{|P{0.16\textwidth}|C{0.12\textwidth}|C{0.18\textwidth}|C{0.14\textwidth}|C{0.16\textwidth}|C{0.16\textwidth}|}
  ...
  \hline
  \TableHeader{Phương pháp} & \TableHeader{Độ phủ} & \TableHeader{Độ lệch chuẩn tải} & \TableHeader{Số lượt tự gán} & \TableHeader{Điểm Jaccard trung bình} & \TableHeader{Tỷ lệ dùng lượt dự phòng} \\ \hline
  \endfirsthead
  \LongTableHeaderBorder
  \TableHeader{Phương pháp} & \TableHeader{Độ phủ} & \TableHeader{Độ lệch chuẩn tải} & \TableHeader{Số lượt tự gán} & \TableHeader{Điểm Jaccard trung bình} & \TableHeader{Tỷ lệ dùng lượt dự phòng} \\ \hline
  \endhead
...
Greedy đạt điểm Jaccard trung bình 0,011, cao gấp 2,75 lần hai phương pháp cơ sở, nhưng độ phủ chỉ đạt 65,9\% và phân phối tải kém đồng đều hơn theo độ lệch chuẩn. Có 23,3\% số bài cần lượt dự phòng; trong lượt này, thuật toán không áp dụng ngưỡng điểm phù hợp tối thiểu. Điểm Jaccard thấp nhất bằng 0 xác nhận một số cặp được gán mà không có chủ đề chung. Không phương pháp nào phát sinh lượt tự gán trong tập kiểm thử, nhưng kết quả này không bao phủ xung đột đã khai báo hoặc quan hệ đồng tác giả. Kết quả chỉ hỗ trợ sử dụng Greedy để tạo danh sách ứng viên cho Chủ tọa kiểm tra; việc đánh giá tính hữu ích trong phân công thực tế hoặc cho phép phân công tự động cần dữ liệu do Chủ tọa xác nhận.

Khi chuyển từ tập dữ liệu tổng hợp nhỏ gồm 60 hồ sơ và 250 bài sang tập dữ liệu gồm 2.565 bài, MRR tăng 22\%, nhưng Hit@5 giảm 19\%, Hit@10 giảm 25\%, điểm phân công trung bình của Greedy giảm 97\% và độ phủ Greedy giảm 12\%. Mức biến động này cho thấy phương pháp dựa trên giao từ khóa nhạy với quy mô và phân bố từ vựng của tập kiểm thử. Dữ liệu phân công thực và phân tích độ nhạy theo cách tạo hồ sơ là điều kiện cần trước khi khái quát kết quả.

\subsection{Phát hiện xung đột lợi ích đa tầng}

Cơ chế phát hiện xung đột lợi ích gồm kiểm tra tự gán, quan hệ do người dùng khai báo và quan hệ đồng tác giả từ một đến ba bậc trên Neo4j trong khoảng thời gian cấu hình. Microbenchmark tại Bảng~\ref{tab:ch4-go-microbenchmark} chỉ bao phủ hai bộ kiểm tra xác định đầu tiên; phép thử chưa đo thời gian hoặc chất lượng phát hiện của lớp đồ thị. Chương cũng chưa có tập cặp xung đột do chuyên gia gán nhãn để tính độ chính xác hoặc số lượng quan hệ xung đột tiềm ẩn được lớp Neo4j phát hiện bổ sung, đồng thời chưa xác nhận hành vi của toàn cơ chế khi lớp đồ thị không khả dụng. Do đó, kết quả hiện tại chỉ xác nhận chi phí của hai bộ kiểm tra xác định, không xác nhận chất lượng của toàn bộ cơ chế đa tầng hoặc khả năng cơ chế này duy trì hoạt động an toàn khi lớp đồ thị không khả dụng.

\par\noindent\rule{\textwidth}{0.4pt}\par

\section{Đánh giá các luồng xử lý AI}

Ba nhóm bằng chứng được trình bày trong mục này: đối chiếu trực tiếp cho Submission Autofill và Submission Gating; TCA cho Reviewer Initial Analysis, Review Quality Auditor và Chair Decision Copilot; đánh giá theo kịch bản cho Chatbot Agent. Bảng sau nêu mẫu số và ranh giới diễn giải trước khi trình bày kết quả chi tiết.
...
\begin{longtable}{|P{0.20\textwidth}|P{0.20\textwidth}|P{0.34\textwidth}|P{0.20\textwidth}|}
  ...
  \LongTableFooterBorder
  \endfoot
  Submission Autofill & 1.127 bài; 48 trường hợp kiểm thử gợi ý chuyên đề & Exact Match, ROUGE, F1, tỷ lệ hoàn tất và tỷ lệ chuyên đề không hợp lệ & Bảo toàn/chuẩn hóa; tính hợp lệ \\ \hline
  Submission Gating & 8 trường hợp kiểm thử luật; 24 trường hợp kiểm thử cảnh báo & Độ chính xác phán quyết, mã luật, chặn sai và phạm vi cảnh báo & Luật cố định; cảnh báo không chặn \\ \hline
  Reviewer Initial Analysis & 1.127 lượt; 1.097 gói TCA & Tỷ lệ trích dẫn bám nguồn, tỷ lệ không bám nguồn, Truthfulness, Coverage và Additionality & Mức bám nguồn theo TCA \\ \hline
  Review Quality Auditor & 3.658 lượt; 2.637--3.472 mục phát hiện được chấm & Phân bố trạng thái, Truthfulness, tính hợp lệ và tỷ lệ đồng thời bám nguồn--hợp lệ & Mức độ nhiễu trong các phát hiện \\ \hline
  ...
  Chatbot Agent & 40 hội thoại & Kết quả hồi cứu, gọi công cụ, quyền truy cập và thời gian đến token đầu tiên (TTFT) & Hành vi theo kịch bản \\ \hline
\end{longtable}
\end{PrismLongTable}

\subsection{Submission Autofill}

Trên 1.127 bài, các trường ngắn và có cấu trúc rõ đạt mức khớp cao hơn trường có cấu trúc phức tạp. F1 theo token của tiêu đề đạt 98,20\%, F1 từ khóa đạt 92,77\%, trong khi F1 tác giả đạt 83,49\%. Chênh lệch giữa tỷ lệ khớp chính xác và F1 theo token của tiêu đề chủ yếu phản ánh khác biệt nhỏ về định dạng hoặc dấu câu.

\begin{PrismLongTable}
\begin{longtable}{|P{0.28\textwidth}|C{0.16\textwidth}|C{0.16\textwidth}|C{0.16\textwidth}|C{0.16\textwidth}|}
  \caption{Mức khớp siêu dữ liệu của Submission Autofill}\LongTableCaptionSpace
  \hline
  \TableHeader{Chỉ số} & \TableHeader{Giá trị trung bình} & \TableHeader{Giá trị trung vị} & \TableHeader{Giá trị thấp nhất} & \TableHeader{Giá trị cao nhất} \\ \hline
  \endfirsthead
  \LongTableHeaderBorder
  \TableHeader{Chỉ số} & \TableHeader{Giá trị trung bình} & \TableHeader{Giá trị trung vị} & \TableHeader{Giá trị thấp nhất} & \TableHeader{Giá trị cao nhất} \\ \hline
  \endhead
  \LongTableFooterBorder
  \endfoot
  Tỷ lệ tiêu đề khớp chính xác & 91,22\% & 100,00\% & 0,00\% & 100,00\% \\ \hline
...
Các giá trị thấp nhất bằng 0 cho thấy luồng thất bại hoàn toàn ở một số bản ghi. Phép đánh giá hiện chưa phân loại nguyên nhân theo dữ liệu thiếu, khả năng đọc PDF hoặc độ phức tạp trong cách trình bày danh sách tác giả. Vì vậy, hệ thống chỉ nên tạo bản nháp để Tác giả xác nhận và chỉnh sửa, không tự động khóa dữ liệu sau khi điền.

Phần gợi ý chuyên đề được đánh giá riêng trên 48 trường hợp kiểm thử. Hệ thống hoàn tất 48/48 trường hợp kiểm thử và không gợi ý chuyên đề ngoài danh sách hợp lệ của hội nghị. Tuy nhiên, tập kiểm thử chưa có nhãn chuyên gia về chuyên đề phù hợp nhất; kết quả chỉ chứng minh tính hợp lệ của đầu ra, không chứng minh độ chính xác của thứ hạng Top-1 hoặc Top-3.

\subsection{Submission Gating}

Submission Gating tách kiểm tra luật cố định khỏi cảnh báo nội dung do AI tạo. Cách phân tách này cho phép quy tắc cố định đưa ra trạng thái nghiệp vụ, trong khi nhận định mang tính diễn giải chỉ tạo cảnh báo hỗ trợ.
...
\begin{longtable}{|P{0.22\textwidth}|P{0.16\textwidth}|P{0.30\textwidth}|P{0.26\textwidth}|}
  ...
  \LongTableFooterBorder
  \endfoot
  Kiểm tra luật cố định & 8 trường hợp kiểm thử & Hoàn tất 8/8; tỷ lệ đúng về phán quyết và mã luật đều đạt 100\%; không chặn sai & Các luật cơ bản chạy đúng trên tập kiểm thử hiện tại \\ \hline
  Cảnh báo nội dung & 24 trường hợp kiểm thử & Hoàn tất 24/24; tạo 26 cảnh báo; không tự động chặn & Luồng giữ đúng vai trò cảnh báo không ngăn nộp; chưa đo độ chính xác nội dung \\ \hline
\end{longtable}
\end{PrismLongTable}

Phần kiểm tra luật có bằng chứng trực tiếp và dễ giải thích. Ngược lại, 26 cảnh báo không ngăn nộp chưa được chuyên gia đánh giá về mức độ bám bằng chứng, mức độ nghiêm trọng và khả năng hỗ trợ người dùng chỉnh sửa. Vì vậy, dữ liệu hiện có chưa hỗ trợ kết luận về chất lượng nội dung của cảnh báo.

\subsection{Reviewer Initial Analysis}

Reviewer Initial Analysis tạo bản định hướng trước khi Phản biện viên viết nhận xét. Mỗi bài có trung bình 4,94 đóng góp được nêu, 6,09 điểm cần lưu ý và 16,74 chú thích. Khối lượng này mô tả lượng thông tin Phản biện viên phải rà soát; nghiên cứu hiện chưa đo trực tiếp tải nhận thức. Vì các điểm cần lưu ý, điểm mạnh, điểm yếu hoặc câu hỏi có thể ảnh hưởng đến nhận định chuyên môn, phép thử tập trung vào mức bám nguồn chứ không xem đầu ra là tài liệu trung lập.
...
\begin{longtable}{|P{0.34\textwidth}|C{0.20\textwidth}|C{0.20\textwidth}|C{0.20\textwidth}|}
  ...
  \LongTableFooterBorder
  \endfoot
  Truthfulness so với bản phản biện & 58,28\% & 50,00\% & 0--100\% \\ \hline
  Tỷ lệ hợp lệ & 71,04\% & 100,00\% & 0--100\% \\ \hline
  Tỷ lệ vừa bám nguồn vừa hợp lệ & 46,99\% & 50,00\% & 0--100\% \\ \hline
\end{longtable}
\end{PrismLongTable}

Theo TCA, tỷ lệ phát hiện vừa bám nguồn vừa hợp lệ đạt 46,99\%. Trong triển khai hiện tại, \CodeBreak{block} được trình bày như cảnh báo ưu tiên nhưng không ngăn nộp, nên quyền quyết định vẫn thuộc Phản biện viên. Tỷ lệ phát hiện chưa đồng thời bám nguồn và hợp lệ cho thấy các phát hiện này chưa phù hợp để trở thành điều kiện chặn cứng.

Hệ thống nên tiếp tục sử dụng các phát hiện này dưới dạng cảnh báo ưu tiên và chỉ dùng quy tắc cố định về trường bắt buộc hoặc trạng thái nghiệp vụ để từ chối thao tác. Nghiên cứu tiếp theo cần đo tỷ lệ cảnh báo sai và hành vi người dùng khi xử lý cảnh báo. Luồng xác nhận riêng khi dịch vụ kiểm tra chất lượng bản phản biện không thể chạy là cơ chế xử lý lỗi vận hành, không phải cơ chế cho phép bỏ qua một cảnh báo \CodeBreak{blocking}.

\subsection{Chair Decision Copilot}

Chair Decision Copilot tổng hợp nhận xét phản biện, phản hồi của tác giả và các điểm đồng thuận hoặc bất đồng trước khi Chủ tọa ra quyết định. Mỗi bài có trung bình 6,18 mục bằng chứng làm căn cứ, 4,30 điểm mạnh, 5,13 điểm yếu, 4,62 câu hỏi, 3,79 điểm đồng thuận, 3,18 điểm bất đồng và 4,32 vấn đề chưa giải quyết. Các đại lượng này cho thấy quy mô bản tổng hợp, nhưng nghiên cứu chưa đo liệu chúng làm giảm hay tăng tải đọc của Chủ tọa. Do luồng nằm gần quyết định cuối cùng, phép thử đánh giá mức bám nguồn của bản tổng hợp, không dùng nhãn chấp nhận hoặc từ chối để suy ra độ chính xác quyết định.
...
Các kết quả trên cho thấy mức độ bám nguồn của bản tổng hợp trong phạm vi phép chấm TCA. Để đánh giá tác động đối với quyết định, nghiên cứu tiếp theo cần đo mức độ đầy đủ và hữu ích theo đánh giá của Chủ tọa, thời gian đọc, độ chính xác quyết định và thiên lệch tự động hóa. Coverage và Additionality riêng lẻ không cung cấp các bằng chứng này.

\subsection{Chatbot Agent của nền tảng}

Chatbot Agent được đánh giá với vai trò trợ lý truy vấn dữ liệu ConferenceSpace theo quyền của từng người dùng, không phải trợ lý nghiên cứu hoặc hệ thống trò chuyện tự do. Bộ thử gồm tám nhóm kịch bản, mỗi nhóm có năm biến thể diễn đạt. Lần chạy thử lưu đầy đủ 40 bản ghi hội thoại, thời gian, token và sự kiện gọi công cụ.
...
\begin{longtable}{|P{0.40\textwidth}|P{0.54\textwidth}|}
  ...
  Tỷ lệ gọi công cụ thành công & 97/128 lượt thành công (75,78\%) \\ \hline
  Thời gian đến token đầu tiên (TTFT) & 2,36 giây \\ \hline
  Thời gian đến câu trả lời hoàn chỉnh đầu tiên & 23,02 giây \\ \hline
  Kiểm tra quyền và phạm vi & Không ghi nhận rò rỉ dữ liệu trong kịch bản quyền; một lượt tạo báo cáo ngoài phạm vi \\ \hline
\end{longtable}
\end{PrismLongTable}
...
\begin{longtable}{|P{0.28\textwidth}|C{0.16\textwidth}|C{0.16\textwidth}|C{0.16\textwidth}|C{0.18\textwidth}|}
  ...
  \hline
  \TableHeader{Luồng xử lý} & \TableHeader{Độ trễ trung bình} & \TableHeader{Độ trễ trung vị} & \TableHeader{Độ trễ cao nhất} & \TableHeader{Token trung bình} \\ \hline
  \endfirsthead
  \LongTableHeaderBorder
  \TableHeader{Luồng xử lý} & \TableHeader{Độ trễ trung bình} & \TableHeader{Độ trễ trung vị} & \TableHeader{Độ trễ cao nhất} & \TableHeader{Token trung bình} \\ \hline
  \endhead
...
Chatbot Agent trả về token đầu tiên sau trung bình 2,36 giây nhưng người dùng phải chờ 23,02 giây để nhận câu trả lời hoàn chỉnh đầu tiên. Giao diện vì vậy cần phân biệt trạng thái đang tra cứu với nội dung trả lời cho người dùng.
...
Các kết quả dẫn đến ba yêu cầu vận hành: chuyển tác vụ dài hoặc vượt ngưỡng phản hồi sang hàng đợi nền; hiển thị tiến độ, lỗi và khả năng thử lại; giảm số lượt gọi công cụ thất bại của Chatbot Agent, hiện là 31 trên tổng số 128 lượt. Tiến trình xử lý đã lưu các gói kết quả và điểm kiểm tra theo từng giai đoạn. Hành vi khi yêu cầu gửi đến dịch vụ AI hết thời gian chờ hoặc khi dịch vụ ngừng hoạt động cần được đánh giá bằng thử nghiệm chủ động gây lỗi trên toàn bộ luồng xử lý.

\par\noindent\rule{\textwidth}{0.4pt}\par

\section{Khảo sát người dùng}

Báo cáo tổng hợp ghi nhận 91 phản hồi dùng cho phân tích, gồm 76 phản hồi của Tác giả, 7 phản hồi của Phản biện viên và 8 phản hồi của Chủ tọa. Đây là mẫu thuận tiện và lệch mạnh về nhóm Tác giả; kết quả mô tả cảm nhận của mẫu tham gia, không đại diện cho toàn bộ người dùng hoặc tạo cơ sở so sánh trực tiếp với quy trình khác. Riêng các thống kê Chủ tọa chưa thể tái lập từ tệp dữ liệu thô hiện có, nên được trình bày như số liệu tổng hợp thứ cấp.
...
\begin{longtable}{|P{0.18\textwidth}|P{0.16\textwidth}|P{0.22\textwidth}|P{0.38\textwidth}|}
  ...
  \LongTableFooterBorder
  \endfoot
  Tác giả & 76 & 3,89/5; 67/76 tích cực & 47/76 chọn Autofill hữu ích nhất; 69/76 người tham gia cho rằng AI giúp giảm số thao tác hoặc thời gian thực hiện \\ \hline
  Phản biện viên & 7 & 4,29/5 & 6/7 tích cực với nhóm chức năng hỗ trợ đọc và phản biện \\ \hline
  Chủ tọa & 8 phản hồi tổng hợp thứ cấp & 4,38/5; 7/8 tích cực & Theo dõi tiến độ: 8/8 tích cực; đánh giá gộp đối với nhóm công cụ AI: 7/8 tích cực \\ \hline
\end{longtable}
\end{PrismLongTable}

Ở nhóm Tác giả, Submission Autofill nhận được phản hồi tích cực nhất, phù hợp với kết quả đối sánh siêu dữ liệu. Tuy nhiên, 69/76 người chỉ báo cáo \textit{cảm nhận} giảm thao tác hoặc tiết kiệm thời gian; khảo sát không đo số phút thực tế. Phản hồi mở yêu cầu cải thiện trích xuất tác giả và cho phép kiểm tra bản nháp khi PDF có nhiều công thức hoặc định dạng phi chuẩn.

Ở nhóm Phản biện viên, câu hỏi khảo sát gộp phần đánh giá về tóm tắt, siêu dữ liệu và thông tin hỗ trợ nên không thể quy kết quả riêng cho Reviewer Initial Analysis. Người tham gia yêu cầu kiểm soát độ dài, số lượng gợi ý và khả năng xem trực tiếp nguồn của từng nhận định.

Với nhóm Chủ tọa, câu hỏi sàng lọc ghi nhận 8/8 người tham gia nêu ít nhất một khía cạnh khiến họ chưa thoải mái; 7/8 cung cấp lý do liên quan đến độ tin cậy, dữ liệu, áp lực từ AI hoặc số trường bắt buộc. Mức độ sử dụng các tính năng cũng không đồng đều: báo cáo tổng hợp cho biết 3/8 người thử nhóm công cụ AI và 6/8 người thử gợi ý phản biện viên, trong khi các câu hỏi hài lòng theo chức năng vẫn dùng mẫu số 8. Do đó, các tỷ lệ chỉ phản ánh từng câu hỏi, không đánh giá riêng Chair Decision Copilot hoặc chất lượng quyết định.

Theo báo cáo tổng hợp, toàn bộ mẫu có 73/91 người tham gia cho biết sẵn sàng giới thiệu nền tảng. Tỷ lệ này chịu ảnh hưởng lớn từ nhóm Tác giả chiếm 83,5\% mẫu; không nên dùng tỷ lệ giữa các vai trò để xếp hạng. Nhìn chung, khảo sát mức độ chấp nhận của người dùng (UAT) cung cấp bằng chứng cảm nhận ban đầu về tính hữu ích, đồng thời nhấn mạnh nhu cầu giữ quyền kiểm tra, sửa và bỏ qua đầu ra AI.

\par\noindent\rule{\textwidth}{0.4pt}\par

\section{Tổng hợp kết quả đánh giá}

Bảng sau tổng hợp quan hệ giữa trách nhiệm, bằng chứng và mức kết luận. Các nhãn mô tả mức độ trực tiếp mà bằng chứng hỗ trợ nhận định, không phải xếp hạng chất lượng sản phẩm.
...
\begin{longtable}{|P{0.27\textwidth}|P{0.45\textwidth}|P{0.22\textwidth}|}
  ...
  \LongTableFooterBorder
  \endfoot
  Hiệu năng endpoint đã chọn & Ba kịch bản k6; p95 dưới 120 ms; 0\% yêu cầu thất bại & Bằng chứng trực tiếp trong cấu hình thử nghiệm \\ \hline
  ...
  Submission Autofill và luật của Submission Gating & Đối chiếu trường trên 1.127 bài; 8/8 trường hợp kiểm thử luật & Trực tiếp trong phạm vi đầu vào và tập kiểm thử \\ \hline
  ...
  Review Quality Auditor & 3.658 lượt; tỷ lệ phát hiện vừa bám nguồn vừa hợp lệ đạt 46,99\% & Chỉ phù hợp làm cảnh báo hỗ trợ \\ \hline
  Chair Decision Copilot & Truthfulness 87,34\%/87,11\%; Coverage 5,27\%/13,82\% & Chỉ số gián tiếp \\ \hline
  Khả năng Chatbot tuân thủ quyền truy cập và phạm vi hỗ trợ & 40 hội thoại; báo cáo hồi cứu ghi 25 đạt; 97/128 lượt gọi công cụ thành công & Bằng chứng theo kịch bản \\ \hline
  Trải nghiệm theo vai trò & Báo cáo UAT: 76 phản hồi của Tác giả, 7 phản hồi của Phản biện viên, 8 phản hồi của Chủ tọa & Bằng chứng cảm nhận \\ \hline
  Khả năng vận hành khi dịch vụ AI gặp lỗi và quản trị dữ liệu & Ranh giới kiến trúc và phân quyền ứng dụng & Chưa đo \\ \hline
\end{longtable}
\end{PrismLongTable}

\subsection{Đối chiếu với nhu cầu ban đầu}

Ở lớp nghiệp vụ, ba kịch bản tải xác nhận các endpoint đã chọn hoạt động trong cấu hình thử nghiệm; tải dài hạn và các luồng chức năng đầy đủ từ đầu đến cuối vẫn cần phép đánh giá riêng. Ở lớp thuật toán, một số chỉ số vượt đường cơ sở ngẫu nhiên, nhưng nhãn thay thế và dữ liệu tổng hợp chưa đủ để suy ra chất lượng phân công hoặc phát hiện xung đột lợi ích đa tầng.
...
Kết quả kỹ thuật và UAT cùng cho thấy Submission Autofill có thể hỗ trợ nhập liệu, nhưng nghiên cứu chưa đo trực tiếp số thao tác hoặc thời gian tiết kiệm được; người dùng vẫn cần kiểm tra các trường hợp PDF phức tạp. Với Reviewer Initial Analysis và Chair Decision Copilot, khảo sát ghi nhận cảm nhận tích cực về nhóm chức năng liên quan nhưng không tách riêng từng luồng. Độ trễ, lỗi gọi công cụ và các phát hiện chưa đủ căn cứ hoặc chưa hợp lệ tiếp tục đặt ra yêu cầu hiển thị trạng thái xử lý, nguồn bằng chứng và khả năng bỏ qua gợi ý.

\subsection{Hạn chế của kết quả thực nghiệm}

Thứ nhất, một số luồng thiếu nhãn chuyên gia. Gợi ý chuyên đề mới được kiểm tra về tính hợp lệ; cảnh báo nội dung không ngăn nộp của Submission Gating chưa được rà soát; Chair Decision Copilot chưa được đối chiếu với đánh giá của Chủ tọa. TCA hỗ trợ chấm trên quy mô lớn nhưng có thể bỏ sót các mệnh đề đúng nhưng được diễn đạt theo cách khác hoặc đánh giá thấp suy luận kỹ thuật phức tạp, nên không thay thế chuyên gia. Chênh lệch 30 gói giữa tập dữ liệu thực nghiệm và tập TCA chưa có bảng kê lý do loại theo luồng, nên nghiên cứu chưa định lượng được thiên lệch chọn mẫu.

Thứ hai, đánh giá đối sánh dựa trên dữ liệu tổng hợp và nhãn leave-one-out theo tác giả. Kết quả chỉ phản ánh quan hệ chủ đề trong tập kiểm thử, không phản ánh dữ liệu phân công thật, mức độ chấp nhận đề xuất hoặc toàn bộ các dạng xung đột lợi ích. Phạm vi dữ liệu AI cũng chủ yếu là bài tiếng Anh từ OpenReview; hiệu quả với bài tiếng Việt hoặc quy trình hội nghị khác chưa được đánh giá.

Thứ ba, thực nghiệm chưa kiểm tra chạy bền, tải phân tán hoặc lỗi đầu cuối khi yêu cầu gửi đến dịch vụ AI hết thời gian chờ hay khi dịch vụ ngừng hoạt động. Cơ chế phân quyền cấp ứng dụng cũng không cho biết nhà cung cấp lưu dữ liệu trong bao lâu, có dùng dữ liệu để huấn luyện hay lưu trữ dữ liệu tại khu vực địa lý nào. Do đó, kết quả chưa đủ để xác nhận khả năng dùng dữ liệu phản biện mật trong vận hành thực tế.

Cuối cùng, UAT là khảo sát mô tả trên mẫu thuận tiện, với cỡ mẫu nhỏ ở hai vai trò chuyên môn. Các thống kê Chủ tọa trong báo cáo tổng hợp không thể tái lập từ tệp dữ liệu thô đang lưu, mức độ sử dụng các tính năng không đồng đều và một số câu hỏi dùng mẫu số khác nhau. Khảo sát chưa đo thời gian hoàn thành nhiệm vụ, tải nhận thức hoặc thiên lệch tự động hóa. Các tỷ lệ UAT vì vậy chỉ phản ánh từng câu hỏi trong mẫu tham gia, không phải đánh giá chung cho toàn bộ nhóm tính năng.

Tóm lại, Chương 4 xác nhận hiệu năng của các endpoint đã chọn và kết quả của tập kiểm thử luật. Các phép truy hồi chủ đề và TCA cung cấp chỉ số gián tiếp, còn UAT cung cấp bằng chứng cảm nhận nhưng chưa có đầy đủ thông tin về nguồn gốc và khả năng truy vết ở nhóm Chủ tọa. Nghiên cứu tiếp theo cần đánh giá chất lượng của toàn bộ cơ chế phát hiện xung đột lợi ích, độ tin cậy của đầu ra AI theo nhận định của chuyên gia và mức độ sẵn sàng triển khai trong hội nghị thực tế.
