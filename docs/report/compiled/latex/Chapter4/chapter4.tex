...
Mỗi phát hiện của Review Quality Auditor gồm nội dung giải thích và mã vấn đề tương ứng. Nội dung giải thích được đối chiếu với bản phản biện đang được kiểm tra để ước lượng mức bám nguồn; mã vấn đề được kiểm tra riêng dựa trên các đặc điểm quan sát được trong bản phản biện.
...
Các chỉ số này mô tả quan hệ giữa đầu ra, dữ liệu nguồn và metareview; thử nghiệm chưa đo mức hữu ích, thời gian đọc hoặc ảnh hưởng đến quyết định của Chủ tọa.
