...
Đối với các luồng AI, bộ thực thi tạo và lưu đầu ra trước; bộ chấm TCA đọc lại các gói đã lưu mà không tạo lại nội dung. Tự động điền bài nộp (Submission Autofill) được đối chiếu với siêu dữ liệu tham chiếu; Kiểm tra trước khi nộp bài (Submission Gating) được tách thành nhánh kiểm tra luật và nhánh cảnh báo không chặn; Phân tích và tóm tắt bài báo (Reviewer Initial Analysis), Kiểm tra chất lượng nhận xét (Review Quality Auditor) và Báo cáo tổng hợp hỗ trợ Chủ tọa (Chair Decision Copilot) được đánh giá theo quan hệ mệnh đề--bằng chứng; Chatbot Agent được chạy theo tám nhóm kịch bản với ba vai trò và được đánh giá thủ công. Hình~\ref{fig:ch4-ai-evaluation-flow} minh họa sự tách biệt giữa tạo đầu ra, đối chiếu trực tiếp, TCA và chấm theo hành vi hội thoại.
