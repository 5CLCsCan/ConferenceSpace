...
Luồng công việc trong \path{.github/workflows/deploy.yml} không xây dựng image trên máy chủ. GitHub Actions xây dựng và đẩy song song ba image frontend, backend và dịch vụ AI lên GHCR; máy chủ VPS chỉ lấy image, cập nhật tệp triển khai, chạy migration và thay container. Luồng công việc được kích hoạt khi commit vào nhánh \textit{main} hoặc khi người vận hành yêu cầu chạy thủ công.
