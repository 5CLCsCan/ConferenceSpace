...
\clearpage
Cấu hình Caddy hiện tại dùng tên miền \path{conference-space.com} và \path{www.conference-space.com}; các quy tắc định tuyến được trình bày trong Đoạn mã~\ref{lst:appendix-b-caddyfile}.
...
\begin{longtable}{|N{0.08\textwidth}|T{0.5\textwidth}|T{0.4\textwidth}|}
