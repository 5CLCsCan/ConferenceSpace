...
\begin{longtable}{|C{0.22\textwidth}|P{0.26\textwidth}|P{0.46\textwidth}|}
  ...
  Submission     &     bài nộp     &     Bản thảo và siêu dữ liệu do tác giả gửi vào một hội nghị hoặc chuyên đề (track) cụ thể. Giữ tiếng Anh trong tên luồng sản phẩm (ví dụ Submission Autofill, Submission Gating) và trong mã kỹ thuật \\ \hline
...
\begin{longtable}{|C{0.22\textwidth}|P{0.26\textwidth}|P{0.46\textwidth}|}
  ...
  Luồng AI      &      luồng xử lý AI / AI workflow      &      Luồng xử lý có dùng AI, có đầu vào, đầu ra, ranh giới kiểm soát và tiêu chí đánh giá riêng. Báo cáo ưu tiên từ luồng thay cho lặp \textit{workflow} khi không cần tên riêng tiếng Anh \\ \hline
  ...
  Thuật toán xác định, có thể kiểm chứng      &      deterministic / thuật toán xác định      &      Lớp xử lý đối sánh phản biện và xung đột lợi ích: kết quả ổn định, có thể tái tạo và kiểm tra lại; không dùng AI tạo sinh. Lần đầu trong đoạn dùng cụm đầy đủ; các lần sau có thể dùng \textit{thuật toán xác định} hoặc \textit{thuật toán có thể kiểm chứng} \\ \hline
  ...
  ReAct     &     Reasoning and Acting     &     Mẫu kết hợp suy luận và gọi công cụ cho agent nhiều bước. Báo cáo giữ tên tiếng Anh và giải thích ngắn, không thêm bản dịch trùng nghĩa \\ \hline
...
\begin{longtable}{|C{0.22\textwidth}|P{0.26\textwidth}|P{0.46\textwidth}|}
  ...
  Proxy      &      chỉ số gián tiếp (proxy)      &      Chỉ số gián tiếp dùng khi không thể đo trực tiếp chất lượng cần quan tâm, ví dụ dùng tỷ lệ mệnh đề bám nguồn để mô tả quan hệ giữa đầu ra AI và dữ liệu nguồn. Không dùng \textit{chỉ báo thay thế} hay \textit{bằng chứng thay thế} \\ \hline
