...
\begin{longtable}{|C{0.22\textwidth}|P{0.26\textwidth}|P{0.46\textwidth}|}
  ...
  Go micro-benchmark      &      (giữ tên tiếng Anh)      &      Thực nghiệm đo trực tiếp thời gian xử lý và mức sử dụng bộ nhớ của thuật toán trong chương trình, không bao gồm chi phí của HTTP, cơ sở dữ liệu và mạng \\ \hline
