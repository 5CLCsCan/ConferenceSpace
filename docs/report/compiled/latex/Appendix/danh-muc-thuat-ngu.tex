...
\begin{longtable}{|C{0.22\textwidth}|P{0.26\textwidth}|P{0.46\textwidth}|}
  ...
  Chair     &     Chủ tọa (Chair)     &     Vai trò chịu trách nhiệm cấu hình hội nghị, theo dõi tiến độ, phân công phản biện và ra quyết định cuối cùng đối với bài nộp. Trong ConferenceSpace thường viết tắt là Chủ tọa; khi cần phân biệt với vai trò đồng điều phối dùng Chủ tọa/Đồng chủ tọa \\ \hline
...
\begin{longtable}{|C{0.22\textwidth}|P{0.26\textwidth}|P{0.46\textwidth}|}
  ...
  Thuật toán cố định, có thể kiểm chứng      &      deterministic / thuật toán xác định      &      Lớp xử lý đối sánh phản biện và xung đột lợi ích: kết quả ổn định, có thể tái tạo và kiểm tra lại; không dùng AI tạo sinh. Lần đầu trong đoạn dùng cụm đầy đủ; các lần sau có thể xen kẽ \textit{thuật toán có thể kiểm chứng} hoặc \textit{thuật toán xác định} \\ \hline
  ...
  Bộ chạy luồng xử lý     &     workflow runner     &     Thành phần chạy luồng AI trên tập dữ liệu đánh giá, lưu đầu ra, điểm kiểm tra, thời gian xử lý, token và trạng thái hoàn tất \\ \hline
...
\begin{longtable}{|C{0.22\textwidth}|P{0.26\textwidth}|P{0.46\textwidth}|}
  ...
  Go micro-benchmark      &      kiểm thử vi mô bằng Go      &      Kiểm thử đo trực tiếp thời gian xử lý và mức sử dụng bộ nhớ của thuật toán trong chương trình, không bao gồm chi phí của HTTP, cơ sở dữ liệu và mạng \\ \hline
