...
\begin{longtable}{|C{0.22\textwidth}|P{0.26\textwidth}|P{0.46\textwidth}|}
  ...
  TCA     &     Textual Claim-based Assessment     &     Khung đánh giá đầu ra AI theo mệnh đề--chứng cứ, gồm độ trung thực (Truthfulness), độ phủ (Coverage) và Additionality. Không diễn giải sai tên viết tắt thành một cụm ghép từ ba chỉ số tiếng Anh \\ \hline
  ...
  Coverage (TCA)     &     độ phủ (Coverage)     &     Trong đánh giá AI: mức độ đầu ra bao phủ các điểm có trong nguồn tham chiếu hoặc trong nội dung do con người tạo ra \\ \hline
  ...
  Additionality      &      tỷ lệ nội dung có căn cứ nằm ngoài tham chiếu      &      Phần nội dung đúng và có chứng cứ nhưng không trùng trực tiếp với tham chiếu của con người \\ \hline
