...
Block & Có ít nhất một phát hiện mức blocking; trạng thái tổng hợp được gắn \CodeBreak{status=block} để ưu tiên hiển thị & Giao diện làm nổi bật phát hiện nghiêm trọng; thao tác gửi vẫn khả dụng; Phản biện viên quyết định chỉnh sửa hoặc tiếp tục gửi \\ \hline
Lỗi thực thi & Dịch vụ không thể hoàn tất bước rà soát & Backend yêu cầu Phản biện viên xác nhận tiếp tục khi không có kết quả và ghi sự kiện vào nhật ký; nhánh này không phải cơ chế ghi đè đối với phát hiện blocking \\ \hline
\end{longtable}

Hệ thống phân biệt phát hiện về chất lượng với lỗi không thể thực hiện bước rà soát. Phát hiện chất lượng, kể cả mức blocking, chỉ cung cấp thông tin để Phản biện viên xem xét và không vô hiệu hóa thao tác gửi. Lỗi thực thi được thông báo rõ, yêu cầu xác nhận tiếp tục và ghi vào nhật ký. Phản biện viên vẫn chịu trách nhiệm về nhận định chuyên môn trong bản phản biện cuối cùng.
