...
| 24  | Token kỹ thuật EN trong prose Ch3 (_submission_, _assignment_, _workspace_…): đã **chọn lọc**, không Việt hóa mù? | Có — chỉ khi câu gượng; giữ code/status/diagram/product (O4)                         |
