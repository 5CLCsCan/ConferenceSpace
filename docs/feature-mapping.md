...
1. Public Landing Entry
   ...
   - **Path:** `/`
   - **Source Component:** `frontend-v2/app/page.tsx`
   ...
   - **Data Shape(s):** `ROUTES`
   - **Evidence:** `frontend-v2/app/page.tsx`; `frontend-v2/lib/routes.ts`

2. Sign In
   - **ID:** `shared-auth-login`
   - **Path:** `/login`
   - **Source Component:** `frontend-v2/app/login/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/login/page.tsx`; `frontend-v2/lib/auth-context.tsx`; `frontend-v2/lib/session-manager.ts`

3. Register Account
   - **ID:** `shared-auth-register`
   - **Path:** `/register`
   - **Source Component:** `frontend-v2/app/register/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/register/page.tsx`; `frontend-v2/lib/auth-context.tsx`

4. Sign Out
   - **ID:** `shared-auth-logout`
   - **Path:** `/role/*`
   - **Source Component:** `frontend-v2/components/dashboard-header.tsx`
   ...
   - **Evidence:** `frontend-v2/components/dashboard-header.tsx`; `frontend-v2/lib/auth-context.tsx`; `frontend-v2/lib/session-manager.ts`
...
1. View Role Selector
   ...
   - **Path:** `/role`
   - **Source Component:** `frontend-v2/app/role/page.tsx`
   ...
   - **Data Shape(s):** `User`, `UserRole`
   - **Evidence:** `frontend-v2/app/role/page.tsx`; `frontend-v2/lib/role-access.ts`; `frontend-v2/lib/auth-context.tsx`
...
2. Switch Active Role Context
   ...
   - **Evidence:** `frontend-v2/app/role/page.tsx`; `frontend-v2/lib/auth-context.tsx`; `frontend-v2/lib/session-manager.ts`
...
1. View Notification Feed
   ...
   - **Path:** `/notifications`
   - **Source Component:** `frontend-v2/app/notifications/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/notifications/page.tsx`; `frontend-v2/hooks/use-notifications.ts`; `frontend-v2/lib/api/notifications.ts`
...
4. Open Notification Action Target
   ...
   - **Evidence:** `frontend-v2/app/notifications/page.tsx`; `frontend-v2/lib/notifications/resolve-action-url.ts`; `frontend-v2/lib/routes.ts`
...
1. View User Profile
   ...
   - **Source Component:** `frontend-v2/app/profile/[user_id]/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/profile/[user_id]/page.tsx`; `frontend-v2/lib/profile/resolve-user-email.ts`; `frontend-v2/lib/api/user.ts`
...
2. Update Profile Information
   ...
   - **Evidence:** `frontend-v2/app/profile/[user_id]/page.tsx`; `frontend-v2/lib/types.ts`

3. Search Academic Author Candidates
   - **ID:** `shared-profile-search-academic-author`
   - **Path:** `/profile/:user_id`
   - **Source Component:** `frontend-v2/components/profile/profile-onboarding-modal.tsx`
   ...
   - **Evidence:** `frontend-v2/components/profile/profile-onboarding-modal.tsx`; `frontend-v2/lib/api/semantic-scholar.ts`
...
4. Link Academic Profile
   ...
   - **Evidence:** `frontend-v2/components/profile/profile-onboarding-modal.tsx`; `frontend-v2/lib/api/user.ts`
...
5. Unlink Academic Profile
   ...
   - **Permission Basis:** Own-profile action only.
   - **Data Shape(s):** `AcademicProfile`, `User`
   - **Evidence:** `frontend-v2/app/profile/[user_id]/page.tsx`; `frontend-v2/lib/api/user.ts`
...
1. View Author Conference Hub
   ...
   - **Path:** `/role/author`
   - **Source Component:** `frontend-v2/components/author/author-conferences.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/author/page.tsx`; `frontend-v2/components/author/author-conferences.tsx`; `frontend-v2/app/role/author/layout.tsx`
...
2. Open Conference Detail Workspace
   ...
   - **Data Shape(s):** `ROUTES`
   - **Evidence:** `frontend-v2/components/author/author-conferences.tsx`; `frontend-v2/lib/routes.ts`; `frontend-v2/app/role/author/layout.tsx`
...
1. View Conference Detail Tabs
   ...
   - **Source Component:** `frontend-v2/components/author/author-conference-detail.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/author/conferences/[conferenceId]/page.tsx`; `frontend-v2/components/author/author-conference-detail.tsx`; `frontend-v2/components/author/conference-detail/*`

2. Start New Submission From Conference
   - **ID:** `author-conference-start-submission`
   - **Path:** `/role/author/conferences/:conferenceId`
   - **Source Component:** `frontend-v2/components/author/conference-detail/conference-header.tsx`
   ...
   - **Evidence:** `frontend-v2/components/author/conference-detail/conference-header.tsx`; `frontend-v2/app/role/author/submissions/new/page.tsx`
...
3. Open Existing Submission From Conference
   ...
   - **Evidence:** `frontend-v2/components/author/author-conference-detail.tsx`; `frontend-v2/components/author/conference-detail/conference-header.tsx`
...
1. View Submission Authoring Form
   ...
   - **Source Component:** `frontend-v2/components/author/submit/paper-submission-form.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/author/submissions/new/page.tsx`; `frontend-v2/app/role/author/submissions/[submissionId]/edit/page.tsx`; `frontend-v2/components/author/submit/paper-submission-form.tsx`

2. Search Existing Users As Co-authors
   - **ID:** `author-submission-search-coauthor`
   - **Path:** `/role/author/submissions/new`
   - **Source Component:** `frontend-v2/components/author/submit/authors-step.tsx`
   ...
   - **Evidence:** `frontend-v2/components/author/submit/authors-step.tsx`; `frontend-v2/lib/api/client.ts`

3. Precheck Manuscript Quality
   - **ID:** `author-submission-precheck-manuscript`
   - **Path:** `/role/author/submissions/new`
   - **Source Component:** `frontend-v2/components/author/submit/file-upload-step.tsx`
   ...
   - **Evidence:** `frontend-v2/components/author/submit/file-upload-step.tsx`; `frontend-v2/lib/api/papers.ts`
...
5. Save Submission Draft
   ...
   - **Evidence:** `frontend-v2/components/author/submit/paper-submission-form.tsx`; `frontend-v2/lib/api/papers.ts`
...
7. Upload Supplementary Files (Placeholder)
   ...
   - **Evidence:** `frontend-v2/components/author/submit/file-upload-step.tsx`
...
1. View Submission Inventory
   ...
   - **Source Component:** `frontend-v2/components/author/author-submissions-list.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/author/submissions/page.tsx`; `frontend-v2/components/author/author-submissions-list.tsx`; `frontend-v2/lib/api/submissions.ts`
...
2. Open Submission Detail From Inventory
   ...
   - **Evidence:** `frontend-v2/components/author/author-submissions-list.tsx`; `frontend-v2/lib/routes.ts`

3. View Submission Detail Workspace
   - **ID:** `author-submission-view-detail`
   - **Path:** `/role/author/submissions/:submissionId`
   - **Source Component:** `frontend-v2/components/author/submission-detail/index.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/author/submissions/[submissionId]/page.tsx`; `frontend-v2/components/author/submission-detail/index.tsx`; `frontend-v2/lib/submissions/resolve-submission-conference.ts`

4. Open Draft Edit From Detail
   - **ID:** `author-submission-open-edit-draft`
   - **Path:** `/role/author/submissions/:submissionId`
   - **Source Component:** `frontend-v2/components/author/submission-detail/submission-header.tsx`
   ...
   - **Data Shape(s):** `Submission`, `ROUTES`
   - **Evidence:** `frontend-v2/components/author/submission-detail/submission-header.tsx`; `frontend-v2/lib/routes.ts`

5. Download Submission Artifacts
   - **ID:** `author-submission-download-file`
   - **Path:** `/role/author/submissions/:submissionId`
   - **Source Component:** `frontend-v2/components/author/submission-detail/overview-tab.tsx`
   ...
   - **Evidence:** `frontend-v2/components/author/submission-detail/overview-tab.tsx`
...
6. Create Discussion Thread (Author)
   ...
   - **Source Component:** `frontend-v2/components/author/submission-detail/discussion-tab.tsx`
   ...
   - **Evidence:** `frontend-v2/components/author/submission-detail/discussion-tab.tsx`; `frontend-v2/lib/api/discussions.ts`; `frontend-v2/components/shared/discussion/api-adapter.ts`
...
7. Reply In Discussion Thread (Author)
   ...
   - **Evidence:** `frontend-v2/components/author/submission-detail/discussion-tab.tsx`; `frontend-v2/lib/api/discussions.ts`
...
8. Upload Revision (Placeholder)
   ...
   - **Evidence:** `frontend-v2/components/author/submission-detail/submission-header.tsx`
...
9. Withdraw Submission (Placeholder)
   ...
   - **Data Shape(s):** N/A (no DTO bound)
   - **Evidence:** `frontend-v2/components/author/submission-detail/overview-tab.tsx`
   - **Backend Status (optional):** `BLOCKED - Withdrawal endpoint/action binding not implemented in frontend-v2.`

10. Rebuttal Panel (Read-only)
    - **ID:** `author-rebuttal-readonly`
    - **Path:** `/role/author/submissions/:submissionId?tab=rebuttal`
    - **Source Component:** `frontend-v2/components/author/submission-detail/rebuttal-tab.tsx`
    ...
    - **Evidence:** `frontend-v2/components/author/submission-detail/rebuttal-tab.tsx`; `frontend-v2/components/shared/rebuttal/types.ts`
...
1. View Reviewer Dashboard
   ...
   - **Path:** `/role/reviewer`
   - **Source Component:** `frontend-v2/components/reviewer/reviewer-dashboard.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/reviewer/page.tsx`; `frontend-v2/components/reviewer/reviewer-dashboard.tsx`; `frontend-v2/hooks/use-reviewer-dashboard.ts`
...
2. Open Recent Assignment
   ...
   - **Evidence:** `frontend-v2/components/reviewer/reviewer-dashboard.tsx`; `frontend-v2/lib/routes.ts`
...
1. View Reviewer Conference Catalog
   ...
   - **Source Component:** `frontend-v2/app/role/reviewer/conferences/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/reviewer/conferences/page.tsx`; `frontend-v2/components/reviewer/reviewer-conferences.tsx`; `frontend-v2/hooks/use-reviewer-dashboard.ts`
...
2. Open Conference Submission Queue
   ...
   - **Evidence:** `frontend-v2/app/role/reviewer/conferences/page.tsx`; `frontend-v2/lib/routes.ts`
...
3. View Assigned Papers In Conference
   ...
   - **Source Component:** `frontend-v2/components/reviewer/assigned-dashboard.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/reviewer/conferences/[conferenceId]/submissions/page.tsx`; `frontend-v2/components/reviewer/assigned-dashboard.tsx`; `frontend-v2/hooks/use-conference-papers.ts`
...
4. Open Assignment From Conference Queue
   ...
   - **Evidence:** `frontend-v2/components/reviewer/assigned-dashboard.tsx`; `frontend-v2/lib/reviewer/assignment-context-cache.ts`; `frontend-v2/lib/routes.ts`

5. Apply To Explore Conference (Placeholder)
   - **ID:** `reviewer-workspace-apply-explore-placeholder`
   - **Path:** `/role/reviewer/conferences`
   - **Source Component:** `frontend-v2/components/reviewer/reviewer-conferences.tsx`
   - **Description:** Renders "Apply" CTA on explore cards without mutation/navigation binding.
   - **Action Type:** `COMMAND`
   - **Permission Basis:** Reviewer guard.
   - **Data Shape(s):** `ReviewerConference`
   - **Evidence:** `frontend-v2/components/reviewer/reviewer-conferences.tsx`
...
1. View Reviewer Invitations
   ...
   - **Source Component:** `frontend-v2/components/reviewer/reviewer-invitations.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/reviewer/invitations/page.tsx`; `frontend-v2/components/reviewer/reviewer-invitations.tsx`; `frontend-v2/hooks/use-reviewer-dashboard.ts`
...
2. Accept Review Invitation
   ...
   - **Evidence:** `frontend-v2/components/reviewer/reviewer-invitations.tsx`; `frontend-v2/lib/api/reviewer.ts`
...
3. Decline Review Invitation
   ...
   - **Permission Basis:** Reviewer guard + invitation card action.
   - **Data Shape(s):** `ReviewRequest`, response status union `"accepted" | "rejected"`
   - **Evidence:** `frontend-v2/components/reviewer/reviewer-invitations.tsx`; `frontend-v2/lib/api/reviewer.ts`; `frontend-v2/lib/types.ts`
...
4. Go To Dashboard From Accepted Invitation (Placeholder)
   ...
   - **Evidence:** `frontend-v2/components/reviewer/reviewer-invitations.tsx`
...
1. View Assignment Review Workspace
   ...
   - **Source Component:** `frontend-v2/components/reviewer/submission-review.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/reviewer/assignments/[assignmentId]/page.tsx`; `frontend-v2/components/reviewer/submission-review.tsx`

2. Resolve Assignment Conference Context
   - **ID:** `reviewer-assignment-resolve-conference-context`
   - **Path:** `/role/reviewer/assignments/:assignmentId`
   - **Source Component:** `frontend-v2/app/role/reviewer/assignments/[assignmentId]/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/reviewer/assignments/[assignmentId]/page.tsx`; `frontend-v2/lib/reviewer/resolve-assignment-conference.ts`; `frontend-v2/lib/reviewer/assignment-context-cache.ts`
...
3. Save Review Draft
   ...
   - **Evidence:** `frontend-v2/components/reviewer/submission-review.tsx`; `frontend-v2/hooks/use-assignment-review.ts`; `frontend-v2/lib/api/reviews.ts`
...
5. Create Discussion Thread (Reviewer)
   ...
   - **Source Component:** `frontend-v2/components/reviewer/submission-review/discussion-tab.tsx`
   - **Description:** Creates reviewer-side discussion thread and refreshes thread/message state.
   - **Action Type:** `COMMAND`
   - **Permission Basis:** Reviewer guard.
   - **Data Shape(s):** `CreateThreadData`, `CreateThreadRequest`, `DiscussionThread`
   - **Evidence:** `frontend-v2/components/reviewer/submission-review/discussion-tab.tsx`; `frontend-v2/lib/api/discussions.ts`
...
7. AI Assistant Analysis (Mock)
   ...
   - **Path:** `/role/reviewer/assignments/:assignmentId`
   - **Source Component:** `frontend-v2/components/reviewer/submission-review/review-sidebar.tsx`
   ...
   - **Evidence:** `frontend-v2/components/reviewer/submission-review/review-sidebar.tsx`
...
8. Rebuttal Panel (Reviewer Read-only)
   ...
   - **Source Component:** `frontend-v2/components/reviewer/submission-review/rebuttal-tab.tsx`
   - **Description:** Displays rebuttal information but disables acknowledgment/write actions.
   - **Action Type:** `VIEW`
   - **Permission Basis:** Reviewer guard.
   - **Data Shape(s):** `RebuttalSettings`, `RebuttalPoint`, `RebuttalSubmission`, `RebuttalPhase`
   - **Evidence:** `frontend-v2/components/reviewer/submission-review/rebuttal-tab.tsx`; `frontend-v2/components/shared/rebuttal/types.ts`
   - **Backend Status (optional):** `BLOCKED - Rebuttal persistence contract is explicitly unavailable.`
...
1. View Completed Reviews Archive
   ...
   - **Source Component:** `frontend-v2/components/reviewer/completed-reviews.tsx`
   - **Description:** Loads completed review assignments with search/sort/infinite scrolling.
   - **Action Type:** `VIEW`
   - **Permission Basis:** Reviewer guard.
   - **Data Shape(s):** `AssignedPaper`
   - **Evidence:** `frontend-v2/app/role/reviewer/completed/page.tsx`; `frontend-v2/components/reviewer/completed-reviews.tsx`; `frontend-v2/hooks/use-completed-reviews.ts`
...
2. Re-open Completed Review Workspace
   ...
   - **Evidence:** `frontend-v2/components/reviewer/completed-reviews.tsx`; `frontend-v2/lib/routes.ts`
...
1. View Chair Dashboard Overview
   ...
   - **Path:** `/role/chair`
   - **Source Component:** `frontend-v2/components/chair/chair-dashboard.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/chair/page.tsx`; `frontend-v2/components/chair/chair-dashboard.tsx`; `frontend-v2/app/role/chair/layout.tsx`
...
2. Open Conference Action From Dashboard
   ...
   - **Data Shape(s):** `ROUTES`
   - **Evidence:** `frontend-v2/components/chair/chair-dashboard.tsx`; `frontend-v2/lib/routes.ts`
...
1. View Chair Conference Portfolio
   ...
   - **Source Component:** `frontend-v2/components/chair/chair-conferences.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/chair/conferences/page.tsx`; `frontend-v2/components/chair/chair-conferences.tsx`; `frontend-v2/lib/api/conferences.ts`
...
2. Open Conference Detail From Portfolio
   ...
   - **Permission Basis:** Chair guard.
   - **Data Shape(s):** `ROUTES`
   - **Evidence:** `frontend-v2/components/chair/chair-conferences.tsx`; `frontend-v2/lib/routes.ts`

3. View Conference Creation Wizard
   - **ID:** `chair-conference-view-create-wizard`
   - **Path:** `/role/chair/conferences/new`
   - **Source Component:** `frontend-v2/app/role/chair/conferences/new/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/chair/conferences/new/page.tsx`; `frontend-v2/components/wizard/creation/*`
...
4. Create Conference
   ...
   - **Evidence:** `frontend-v2/app/role/chair/conferences/new/page.tsx`; `frontend-v2/lib/api/conferences.ts`
...
5. Save Conference Draft In Wizard (Local Only)
   ...
   - **Permission Basis:** Chair guard.
   - **Data Shape(s):** `ConferenceFormData`
   - **Evidence:** `frontend-v2/app/role/chair/conferences/new/page.tsx`
...
1. View Conference Detail Tabs
   ...
   - **Source Component:** `frontend-v2/app/role/chair/conferences/[conferenceId]/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/chair/conferences/[conferenceId]/page.tsx`; `frontend-v2/components/chair/conference-detail/conference-detail-header.tsx`
...
2. View Dedicated Submissions Route
   ...
   - **Source Component:** `frontend-v2/app/role/chair/conferences/[conferenceId]/submissions/page.tsx`
   - **Description:** Provides submissions-only entrypoint while retaining conference context/header.
   - **Action Type:** `VIEW`
   - **Permission Basis:** Chair guard.
   - **Data Shape(s):** `ConferenceInfo`, `TabId`
   - **Evidence:** `frontend-v2/app/role/chair/conferences/[conferenceId]/submissions/page.tsx`; `frontend-v2/components/chair/conference-detail/conference-detail-header.tsx`

3. Conference Settings Access (Placeholder)
   - **ID:** `chair-conference-settings-placeholder`
   - **Path:** `/role/chair/conferences/:conferenceId`
   - **Source Component:** `frontend-v2/components/chair/conference-detail/conference-detail-header.tsx`
   - **Description:** Settings button is rendered in header without click handler.
   - **Action Type:** `COMMAND`
   - **Permission Basis:** Chair guard.
   - **Data Shape(s):** `ConferenceInfo`
   - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-detail-header.tsx`
...
4. CFP Editor/Publisher (Read-only)
   ...
   - **Path:** `/role/chair/conferences/:conferenceId`
   - **Source Component:** `frontend-v2/components/chair/conference-detail/conference-cfp.tsx`
   ...
   - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-cfp.tsx`
...
5. View Conference Important Dates
   ...
   - **Path:** `/role/chair/conferences/:conferenceId`
   - **Source Component:** `frontend-v2/components/chair/conference-detail/conference-dates.tsx`
   - **Description:** Renders API-backed schedule timeline from conference configuration date fields.
   - **Action Type:** `VIEW`
   - **Permission Basis:** Chair guard.
   - **Data Shape(s):** `ImportantDate`
   - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-dates.tsx`; `frontend-v2/lib/api/conferences.ts`

6. View Committee Roster
   - **ID:** `chair-conference-view-committee`
   - **Path:** `/role/chair/conferences/:conferenceId`
   - **Source Component:** `frontend-v2/components/chair/conference-detail/conference-committee.tsx`
   - **Description:** Shows reviewer committee membership and pending invite counts.
   - **Action Type:** `VIEW`
   - **Permission Basis:** Chair guard.
   - **Data Shape(s):** `User`, `Reviewer`, `ReviewerListResponse`
   - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-committee.tsx`; `frontend-v2/lib/api/conferences.ts`

7. View Analytics Fallback Cards
   - **ID:** `chair-conference-view-analytics-fallback`
   - **Path:** `/role/chair/conferences/:conferenceId`
   - **Source Component:** `frontend-v2/components/chair/conference-detail/conference-detail-dashboard.tsx`
   ...
   - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-detail-dashboard.tsx`; `frontend-v2/lib/api/conferences.ts`
...
8. View COI Dashboard
   ...
   - **Path:** `/role/chair/conferences/:conferenceId`
   - **Source Component:** `frontend-v2/components/chair/conference-detail/conference-coi.tsx`
   ...
   - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-coi.tsx`; `frontend-v2/lib/api/coi.ts`
...
10. Moderate/Dismiss COI Flags (Placeholder)
    ...
    - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-coi.tsx`
...
1. View Submission Table
   ...
   - **Path:** `/role/chair/conferences/:conferenceId/submissions`
   - **Source Component:** `frontend-v2/components/chair/conference-detail/conference-submissions.tsx`
   ...
   - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-submissions.tsx`; `frontend-v2/lib/api/submissions.ts`; `frontend-v2/lib/api/reviews.ts`
...
2. Open Submission Decision Workspace
   ...
   - **Evidence:** `frontend-v2/components/chair/conference-detail/conference-submissions.tsx`; `frontend-v2/lib/routes.ts`

3. View Submission Detail Workspace
   - **ID:** `chair-submission-view-detail`
   - **Path:** `/role/chair/conferences/:conferenceId/submissions/:submissionId`
   - **Source Component:** `frontend-v2/app/role/chair/conferences/[conferenceId]/submissions/[submissionId]/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/chair/conferences/[conferenceId]/submissions/[submissionId]/page.tsx`; `frontend-v2/components/chair/conference-detail/submission-detail-content.tsx`
...
4. View Review Analytics & Reviewer Feedback
   ...
   - **Source Component:** `frontend-v2/components/chair/submission-review-tab.tsx`
   ...
   - **Evidence:** `frontend-v2/components/chair/submission-review-tab.tsx`; `frontend-v2/lib/api/reviews.ts`
...
5. Save Final Submission Decision
   ...
   - **Evidence:** `frontend-v2/components/chair/submission-review-tab.tsx`; `frontend-v2/lib/api/submissions.ts`
...
6. Save Revision Decision (Placeholder)
   ...
   - **Evidence:** `frontend-v2/components/chair/submission-review-tab.tsx`; `frontend-v2/lib/types.ts`
...
7. View Submission History Timeline
   ...
   - **Source Component:** `frontend-v2/components/chair/conference-detail/submission-detail/chair-history-tab.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/chair/conferences/[conferenceId]/submissions/[submissionId]/page.tsx`; `frontend-v2/components/chair/conference-detail/submission-detail/chair-history-tab.tsx`

8. Submission Settings Access (Placeholder)
   - **ID:** `chair-submission-settings-placeholder`
   - **Path:** `/role/chair/conferences/:conferenceId/submissions/:submissionId`
   - **Source Component:** `frontend-v2/components/chair/conference-detail/submission-detail-header.tsx`
   - **Description:** Submission-level settings button is rendered without handler.
   - **Action Type:** `COMMAND`
   - **Permission Basis:** Chair guard.
   - **Data Shape(s):** `SubmissionDetail`
   - **Evidence:** `frontend-v2/components/chair/conference-detail/submission-detail-header.tsx`
...
1. Create Discussion Thread (Chair)
   ...
   - **Source Component:** `frontend-v2/components/chair/conference-detail/submission-detail/chair-discussion-tab.tsx`
   - **Description:** Creates chair-visible discussion thread for submission oversight.
   - **Action Type:** `COMMAND`
   - **Permission Basis:** Chair guard.
   - **Data Shape(s):** `CreateThreadData`, `CreateThreadRequest`, `DiscussionThread`
   - **Evidence:** `frontend-v2/components/chair/conference-detail/submission-detail/chair-discussion-tab.tsx`; `frontend-v2/lib/api/discussions.ts`
...
3. View Schedule Planner
   ...
   - **Source Component:** `frontend-v2/app/role/chair/schedules/page.tsx`
   ...
   - **Evidence:** `frontend-v2/app/role/chair/schedules/page.tsx`
...
4. Schedule Data Source (Mock)
   ...
   - **Evidence:** `frontend-v2/app/role/chair/schedules/page.tsx`
   - **Backend Status (optional):** `BLOCKED - No schedule API integration is wired in frontend-v2.`
