    ...
    <div className="space-y-3">
      ...
      */}
      <div className="rounded-lg border border-amber-300 bg-amber-50 px-3 py-2 text-xs text-amber-800">
        Rebuttal submission is currently read-only. The backend rebuttal persistence contract is
        not available yet, so draft and submit actions are disabled to avoid unsaved changes
        (conference {conferenceId}, submission {submissionId}).
      </div>
