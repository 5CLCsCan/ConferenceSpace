...
export function DashboardHeader({ role }: DashboardHeaderProps) {
  ...
  const roleLinks: Record<DashboardHeaderProps["role"], { href: string; label: string }[]> = {
    author: [
      { href: "/role/author", label: t("dashboard.header.links.author.dashboard") },
      { href: "/role/author/submissions", label: t("dashboard.header.links.author.myPapers") },
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 bg-white border-neutral-200">
                ...
                <DropdownMenuItem
                  ...
                  onClick={() => router.push(`/profile/${user.id || "me"}`)}
                >
