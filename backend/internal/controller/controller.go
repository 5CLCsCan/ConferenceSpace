...
import (
	...
	usageeventController "github.com/dcao/conferencespace/internal/controller/usage_event"
...
type Controller struct {
	...
	UsageEvent         *usageeventController.Controller
}
...
func NewController(orch *orchestrator.Orchestrator, store *storage.Storage, fileStore fileStorage.StorageInterface, clients *clients.Clients, serverEnv string) *Controller {
	...
	return &Controller{
		...
		UsageEvent:         usageeventController.New(store),
	}
}
