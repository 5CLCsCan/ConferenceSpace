...
const content: Record<TabType, { icon: string; title: string; description: string }> = {
  "my-conferences": {
    ...
    description: t("runtime.components.conference.empty-state.prop_description_create_your_first_conference_to_get"),
  },
  explore: {
    icon: "explore",
    title: t("runtime.components.conference.empty-state.prop_title_no_conferences_to_explore"),
    description: t("runtime.components.conference.empty-state.prop_description_there_are_no_public_conferences_available"),
  },
  archived: {
    icon: "archive",
    title: t("runtime.components.conference.empty-state.prop_title_no_archived_conferences"),
    description: t("runtime.components.conference.empty-state.prop_description_completed_conferences_will_appear_here_for"),
  },
}
...
export function NoResultsState() {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <h3 className="text-sm font-bold text-[#1B3C53] dark:text-white mb-1 tracking-tight">
        {t("runtime.components.conference.empty-state.text_no_results_found")}{" "}</h3>
      <p className="text-[10px] font-medium text-slate-400 text-center">
        {t("runtime.components.conference.empty-state.text_try_adjusting_your_search_terms")}{" "}</p>
    </div>
  )
}
