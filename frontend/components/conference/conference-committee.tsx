    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-3 text-lg leading-relaxed text-gray-600">
          Danh sách các thành viên ban tổ chức{canSeeReviewers ? " và program committee" : ""}
        </p>
      </div>

      {/* Conference Chairs - Public for all roles */}
      <div>
        <h2 className="flex items-center gap-2 text-2xl font-bold text-gray-900">Conference Chairs</h2>
      ...
      {canSeeReviewers ? (
        <div>
          <h2 className="flex items-center gap-2 text-2xl font-bold text-gray-900">Program Committee & Reviewers</h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {member.total_reviews && (
                      <p className="mt-3 text-xs text-gray-500">{member.total_reviews} reviews completed</p>
                    )}
                  </div>
                </div>
              </Card>
        ...
        <Card className="p-8 text-center">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-900">Thông Tin Hạn Chế</h3>
          <p className="mt-2 text-gray-600">
            Danh sách reviewers và program committee chỉ hiển thị cho Conference Chairs để đảm bảo tính công bằng trong
            quá trình review.
          </p>
        </Card>
      )}
