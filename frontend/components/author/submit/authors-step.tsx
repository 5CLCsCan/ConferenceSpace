    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div className="px-4 py-3 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center">
          <h3 className="text-sm font-bold text-[#1B3C53] dark:text-white leading-[1.2] tracking-tight">
            {t("runtime.components.author.submit.authors-step.text_author_list")}
            {authors.length})
          </h3>
          <button
          ...
          >
            ...
            {t("runtime.components.author.submit.authors-step.text_naming_guidelines")}{" "}
          </button>
        </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {currentUserEmail && author.email === currentUserEmail && (
                        <span className="px-1.5 py-0.5 rounded text-[8px] font-bold bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 uppercase tracking-wide">
                          {t("runtime.components.author.submit.authors-step.text_you")}{" "}
                        </span>
                      )}
                    </div>
              ...
              <div className="flex items-center gap-2 w-full md:w-auto mt-2 md:mt-0 justify-between md:justify-end">
                {editingAuthorId === author.id ? (
                  <div className="flex items-center gap-1.5">
                    ...
                    >
                      {t("runtime.components.author.submit.authors-step.text_save")}
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      {t("runtime.components.author.submit.authors-step.text_cancel")}
                    </button>
                  </div>
                ) : (
                  <>
                    <label className="flex items-center gap-1.5 cursor-pointer select-none">
                      ...
                      <span className="text-[10px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                        {t("runtime.components.author.submit.authors-step.text_correspondent")}{" "}
                      </span>
                    </label>
                    <div className="flex items-center border-l border-slate-200 dark:border-slate-600 pl-2 ml-1">
                      <button
                        ...
                        title={t(
                          "runtime.components.author.submit.authors-step.title_edit_details",
                        )}
                      >
                      ...
                      {index > 0 && (
                        <button
                          ...
                          title={t(
                            "runtime.components.author.submit.authors-step.title_remove_author",
                          )}
                        >
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div className="px-4 pt-4 pb-3 border-b border-slate-100 dark:border-slate-700">
          <h3 className="text-sm font-bold text-[#1B3C53] dark:text-white leading-[1.2] tracking-tight">
            {t("runtime.components.author.submit.authors-step.text_add_co_author")}{" "}
          </h3>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="flex flex-col gap-1.5">
              <span className="text-[10px] font-bold text-[#141414] dark:text-white uppercase tracking-widest">
                {t("runtime.components.author.submit.authors-step.text_first_name")}{" "}
              ...
              <input
                ...
                placeholder={t(
                  "runtime.components.author.submit.authors-step.placeholder_e_g_john",
                )}
            ...
            <div className="flex flex-col gap-1.5">
              <span className="text-[10px] font-bold text-[#141414] dark:text-white uppercase tracking-widest">
                {t("runtime.components.author.submit.authors-step.text_last_name")}{" "}
                <span className="text-red-500 ml-0.5">*</span>
              </span>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-1.5 md:col-span-2 relative" ref={dropdownRef}>
              <span className="text-[10px] font-bold text-[#141414] dark:text-white uppercase tracking-widest">
                {t("runtime.components.author.submit.authors-step.text_email_address")}{" "}
                <span className="text-red-500 ml-0.5">*</span>
              </span>
              <input
                type="email"
                ...
                placeholder={t(
                  "runtime.components.author.submit.authors-step.placeholder_e_g_john_doe_university_edu",
                )}
                className="w-full h-10 text-xs font-normal py-2 px-3.5 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-[#141414] dark:text-white placeholder:text-slate-400 focus:ring-2 focus:ring-[#1B3C53] focus:border-[#1B3C53] transition-all"
              />
                  ...
                  {isSearching ? (
                    <div className="flex items-center justify-center p-3 gap-2">
                      ...
                      <span className="text-xs text-slate-500">
                        {t("runtime.components.author.submit.authors-step.text_searching")}
                      </span>
                    </div>
            ...
            <div className="flex flex-col gap-1.5">
              <span className="text-[10px] font-bold text-[#141414] dark:text-white uppercase tracking-widest">
                {t("runtime.components.author.submit.authors-step.text_affiliation")}{" "}
                <span className="text-red-500 ml-0.5">*</span>
              </span>
              <input
                type="text"
                ...
                placeholder={t(
                  "runtime.components.author.submit.authors-step.placeholder_e_g_stanford_university",
                )}
                className="w-full h-10 text-xs font-normal py-2 px-3.5 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-[#141414] dark:text-white placeholder:text-slate-400 focus:ring-2 focus:ring-[#1B3C53] focus:border-[#1B3C53] transition-all"
              />
            </div>
            <div className="flex flex-col gap-1.5">
              <span className="text-[10px] font-bold text-[#141414] dark:text-white uppercase tracking-widest">
                {t("runtime.components.author.submit.authors-step.text_country")}{" "}
                <span className="text-red-500 ml-0.5">*</span>
              </span>
              <div className="relative">
                <select
        ...
        <div className="px-4 pt-2 pb-3 flex items-center justify-end gap-3 border-t border-slate-100 dark:border-slate-700">
          <button
            type="button"
            onClick={() =>
              onNewAuthorChange({
          ...
          >
            ...
            {t("runtime.components.author.submit.authors-step.text_add_author")}{" "}
          </button>
        </div>
      </div>
      ...
      {showGuidelines && (
        ...
        >
          <div
            className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 shadow-xl w-full max-w-sm"
          ...
          >
            ...
            <ul className="px-3 py-2.5 space-y-2 text-[10px] text-slate-600 dark:text-slate-300">
              ...
              <li className="flex gap-1.5">
                <span className="material-symbols-outlined text-[12px] text-amber-500 mt-px shrink-0">
                  warning
                </span>
                <span>
