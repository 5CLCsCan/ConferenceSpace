                ...
                <thead className="bg-slate-50 text-[10px] uppercase text-slate-400 font-bold border-b border-slate-200 tracking-widest">
                  <tr>
                    <th className="px-4 py-2.5">
                      {t(
                        "runtime.components.chair.conference-detail.conference-committee.text_name",
                      )}
                    </th>
                    <th className="px-4 py-2.5">
                      {t(
                        "runtime.components.chair.conference-detail.conference-committee.text_email",
                      )}
                    </th>
                    <th className="px-4 py-2.5">
                      {t(
                        "runtime.components.chair.conference-detail.conference-committee.text_role",
                      )}
                    </th>
                    <th className="px-4 py-2.5">
                      {t(
                        "runtime.components.chair.conference-detail.conference-committee.text_domains",
                      )}
                    </th>
                  </tr>
                </thead>
