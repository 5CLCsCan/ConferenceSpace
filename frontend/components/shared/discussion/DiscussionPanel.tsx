      ...
      <div className="mb-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative flex-1 min-w-[200px] max-w-xs">
            <span className="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-[14px] text-slate-400">
              search
            </span>
            <input
              type="text"
          ...
          <div className="relative">
            ...
            <span className="absolute right-2 top-2 pointer-events-none material-symbols-outlined text-[12px] text-slate-400">
              expand_more
            </span>
          </div>
        ...
        {pinnedThreads.length > 0 && (
          <div className="space-y-2">
            <div className="flex items-center gap-2 px-1">
              <span className="material-symbols-outlined text-[12px] text-amber-500 filled">
                push_pin
              </span>
