...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{t("runtime.components.ui.sidebar.text_toggle_sidebar")}</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={t("runtime.components.ui.sidebar.aria_label_toggle_sidebar")}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={t("runtime.components.ui.sidebar.title_toggle_sidebar")}
      className={cn(
