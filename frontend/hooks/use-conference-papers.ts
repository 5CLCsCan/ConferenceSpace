...
export function useConferencePapers(
  ...
  const { data, error, isLoading, isValidating, mutate } = useSWR(
    ...
    async () => {
      ...
      const response = await getReviewerPapersWithPagination(reviewerId, conferenceId, params)
...
export function usePrefetchConferencePapers(
  ...
  return useSWR(key, () => getReviewerPapersWithPagination(reviewerId, conferenceId, params), {
    ...swrConfig,
