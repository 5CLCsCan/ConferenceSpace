...
export const mockReviewRequests = [
  {
    id: "req-1",
    conference_id: "conf-2025",
    conference_name: "International Conference on Advanced Computing",
    conference_acronym: "ICAC 2025",
    requested_by_name: "Dr. Sarah Chen",
  ...
  },
  {
    ...
    requested_at: "2025-02-28T14:30:00Z",
  ...
  {
    id: "req-3",
    conference_id: "conf-2025-6",
    conference_name: "Neural Information Processing Systems",
    conference_acronym: "NeurIPS 2025",
    requested_by_name: "Prof. David Kim",
    requested_at: "2025-03-05T09:15:00Z",
    status: "pending" as const,
    expertise_match: 85,
    papers_count: 6,
    estimated_hours: 18,
  ...
  {
    id: "req-4",
    conference_id: "conf-2025-3",
    conference_name: "Conference on Computer Vision and Pattern Recognition",
  ...
  {
    id: "req-5",
    conference_id: "conf-2025-4",
    conference_name: "ACM Conference on Human Factors in Computing Systems",
    conference_acronym: "CHI 2025",
    requested_by_name: "Dr. Emma Williams",
    requested_at: "2025-02-20T15:45:00Z",
  ...
  {
    id: "req-6",
    conference_id: "conf-2025-5",
    conference_name: "International Conference on Software Engineering",
    conference_acronym: "ICSE 2025",
    requested_by_name: "Prof. James Anderson",
    requested_at: "2025-03-02T13:20:00Z",
    status: "pending" as const,
    expertise_match: 79,
    papers_count: 5,
    estimated_hours: 15,
  ...
  {
    id: "req-7",
    conference_id: "conf-2025-7",
    conference_name: "ACM SIGMOD International Conference on Management of Data",
    conference_acronym: "SIGMOD 2025",
    requested_by_name: "Dr. Maria Garcia",
    requested_at: "2025-02-25T10:30:00Z",
    status: "accepted" as const,
    expertise_match: 86,
    papers_count: 4,
    estimated_hours: 12,
  ...
  {
    id: "req-8",
    conference_id: "conf-2025-8",
    conference_name: "International Conference on Robotics and Automation",
    conference_acronym: "ICRA 2025",
    requested_by_name: "Prof. Michael Rodriguez",
    requested_at: "2025-03-04T16:00:00Z",
    status: "pending" as const,
    expertise_match: 83,
    papers_count: 5,
    estimated_hours: 15,
